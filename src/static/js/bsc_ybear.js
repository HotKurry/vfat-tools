...
async function main() {
  ...
  const rewardsPerWeek = (((await HONEY_CHEF.rewardPerBlock()) / 1e18) * 604800) / 3

  const tokens = {}
  const prices = await getBscPrices()

  await loadBscBearChefContract(
    App,
    tokens,
    prices,
    HONEY_CHEF,
...
async function loadBscBearChefContract(
  App,
  tokens,
  prices,
  chef,

...
const GEMZ_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract GemzToken', name: '_gemz', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
      {internalType: 'address', name: '_feeAddress', type: 'address'},
      {internalType: 'uint256', name: '_gemzPerBlock', type: 'uint256'},
  ...
  },
  {
    inputs: [],
    name: 'gemz',
    outputs: [{internalType: 'contract GemzToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  {
    inputs: [{internalType: 'uint256', name: '_gemzPerBlock', type: 'uint256'}],
...
async function main() {
  ...
  const rewardsPerWeek = (((await GEMZ_CHEF.gemzPerBlock()) / 1e18) * 604800) / 3

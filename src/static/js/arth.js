...
const Boardrooms = [
  {
    name: 'ArthLiquidityBoardroom',
    address: '0xd5f501C4cDBFca915f04d4aE3853A904C9A35Af5',
    lpt: '0x35b6f9e6300aa6c722ea189e096b0b073025806f',
    stakeTokenTicker: 'ARTH-DAI LP',
    ratio: 0.7,
  },
  {
    name: 'MahaLiquidityBoardroom',
    address: '0x677d54d7DEf7Da25addE1827e000b81A65b1F408',
    lpt: '0x35b6f9e6300aa6c722ea189e096b0b073025806f',
    stakeTokenTicker: 'MAHA-ETH LP',
    ratio: 0.1,
  },
  {
    name: 'ArthBoardroom',
    address: '0xdEc0b3bD49347c75fe1C44A219aB474a13e68FfD',
    lpt: '0x35b6f9e6300aa6c722ea189e096b0b073025806f',
    stakeTokenTicker: 'ARTH',
    ratio: 0.2,
  },
]
...
async function main() {
  ...
  const p2 = await loadSynthetixPool(
    App,
    tokens,
    prices,
    c2.abi,
    c2.address,
    c2.rewardTokenFunction,
    c2.stakeTokenFunction
  )

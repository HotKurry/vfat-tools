...
const OPTIONROOM_ABI = [
  ...
  },
  {
    anonymous: false,
    inputs: [
      {indexed: false, internalType: 'uint256', name: 'incvRewardPerBlock', type: 'uint256'},
      {indexed: false, internalType: 'uint256', name: 'incvRewardFinsishBlock', type: 'uint256'},
  ...
  },
  {
    constant: false,
    inputs: [
      {internalType: 'uint256', name: 'incvRewardsPerBlock', type: 'uint256'},
      {internalType: 'uint256', name: 'incvRewardsPeriodInDays', type: 'uint256'},
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'incvReward', type: 'uint256'},
    ],
    payable: false,
    stateMutability: 'view',
    type: 'function',
  ...
  },
  {
    ...
    name: 'incvRewardInfo',
    outputs: [
      {internalType: 'uint256', name: 'cBlockNumber', type: 'uint256'},
      {internalType: 'uint256', name: 'incvRewardPerBlock', type: 'uint256'},
      {internalType: 'uint256', name: 'incvRewardFinishBlock', type: 'uint256'},
      {internalType: 'uint256', name: 'incvRewardFinishTime', type: 'uint256'},
...
async function loadSynthetixRoomPoolInfo(
  App,
  tokens,
  prices,
  stakingAbi,
  ...
  const calls = [
    STAKING_MULTI.incvFinishBlock(),
    STAKING_MULTI.balanceOf(App.YOUR_ADDRESS),
    STAKING_MULTI.incvRewardInfo(),
    STAKING_MULTI.rewards(App.YOUR_ADDRESS),
  ]

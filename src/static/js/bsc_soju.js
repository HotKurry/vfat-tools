...
const SOJU_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract SojuToken', name: '_soju', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
      {internalType: 'address', name: '_feeAddress', type: 'address'},
      {internalType: 'uint256', name: '_sojuPerBlock', type: 'uint256'},
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accSojuPerShare', type: 'uint256'},
  ...
  },
  {
    inputs: [],
    name: 'soju',
    outputs: [{internalType: 'contract SojuToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  {
    inputs: [{internalType: 'uint256', name: '_sojuPerBlock', type: 'uint256'}],
...
async function main() {
  ...
  const SOJU_CHEF_ADDR = '0x0d15efa4655ef8e389374eb232bd1fdc82b58df8'
  const rewardTokenTicker = 'SOJU'
  const SOJU_CHEF = new ethers.Contract(SOJU_CHEF_ADDR, SOJU_CHEF_ABI, App.provider)

  const rewardsPerWeek = (((await SOJU_CHEF.sojuPerBlock()) / 1e18) * 604800) / 3

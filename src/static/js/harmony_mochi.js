...
const MOCHI_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract CakeToken', name: '_mochi', type: 'address'},
...
async function main() {
  ...
  const multiplier = await MOCHI_CHEF.getMultiplier(blockNumber, blockNumber + 1)
  const rewardPerBlock = await MOCHI_CHEF.mochiPerBlock()

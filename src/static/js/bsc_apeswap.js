...
const APESWAP_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract BananaToken', name: '_banana', type: 'address'},
      {internalType: 'contract BananaSplitBar', name: '_bananaSplit', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
      {internalType: 'uint256', name: '_bananaPerBlock', type: 'uint256'},
  ...
  },
  {
    inputs: [],
    name: 'cake',
    outputs: [{internalType: 'contract BananaToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    inputs: [],
    name: 'syrup',
    outputs: [{internalType: 'contract BananaSplitBar', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
...
async function main() {
  ...
  const rewardsPerWeek = (((await APESWAP_CHEF.cakePerBlock()) / 1e18) * 604800) / 3

  const rewardsSoulPerWeek = (((await APESWAP_SOUL_CHEF.rewardPerBlock()) / 1e18) * 604800) / 3
  ...
  await loadSoulChefContract(
    App,
    tokens,
    prices,
    APESWAP_SOUL_CHEF,
    APESWAP_SOUL_CHEF_ADDR,
    APESWAP_SOUL_CHEF_ABI,
    rewardSoulTokenTicker,
    'rewardToken',
    null,
    rewardsSoulPerWeek,
    'pendingReward'
...
async function loadSoulChefContract(
  App,
  tokens,
  prices,
  chef,

...
const CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract AbraKadabraToken', name: '_abrakadabra', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
      {internalType: 'address', name: '_feeAddress', type: 'address'},
      {internalType: 'uint256', name: '_abrakadabraPerBlock', type: 'uint256'},
  ...
  },
  {
    inputs: [],
    name: 'abrakadabra',
    outputs: [{internalType: 'contract AbraKadabraToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
    inputs: [],
    name: 'abrakadabraPerBlock',
    outputs: [{internalType: 'uint256', name: '', type: 'uint256'}],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accAbraKadabraPerShare', type: 'uint256'},
  ...
  {
    inputs: [{internalType: 'uint256', name: '_abrakadabraPerBlock', type: 'uint256'}],
...
async function main() {
  ...
  const CHEF_ADDR = '0xe077670f53421d2e1d1ee1918f0c43e942ed60d2'
  const rewardTokenTicker = 'ABRA'
  const CHEF = new ethers.Contract(CHEF_ADDR, CHEF_ABI, App.provider)

  const rewardsPerWeek = (((await CHEF.abrakadabraPerBlock()) / 1e18) * 604800) / 3

...
const BDP_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract BDPToken', name: '_BDP', type: 'address'},
  ...
  },
  {
    inputs: [],
    name: 'BDP',
    outputs: [{internalType: 'contract BDPToken', name: '', type: 'address'}],
...
const bALPHA_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract bAlphaToken', name: '_bAlpha', type: 'address'},
      {internalType: 'uint256', name: '_rewardPerBlock', type: 'uint256'},
      {internalType: 'uint256', name: '_startBlock', type: 'uint256'},
  ...
  },
  {
    inputs: [],
    name: 'bAlpha',
    outputs: [{internalType: 'contract bAlphaToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
...
async function main() {
  ...
  const bALPHA_CHEF = new ethers.Contract(bALPHA_CHEF_ADDR, bALPHA_CHEF_ABI, App.provider)
  ...
  const {prices} = await loadChefContract(
    App,
    bALPHA_CHEF,
    bALPHA_CHEF_ADDR,
    bALPHA_CHEF_ABI,

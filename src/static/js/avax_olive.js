...
const OLIVE_CHEF_ABI = [
  {
    type: 'constructor',
    stateMutability: 'nonpayable',
    inputs: [
      {type: 'address', name: '_olive', internalType: 'contract OliveToken'},
      {type: 'address', name: '_devaddr', internalType: 'address'},
      {type: 'uint256', name: '_olivePerBlock', internalType: 'uint256'},
  ...
  },
  {
    ...
    inputs: [
      {type: 'address', name: 'user', internalType: 'address', indexed: true},
      {type: 'uint256', name: 'olivePerBlock', internalType: 'uint256', indexed: false},
    ],
    anonymous: false,
  },
  {
  ...
  {type: 'function', stateMutability: 'nonpayable', outputs: [], name: 'massUpdatePools', inputs: []},
  {
    type: 'function',
    stateMutability: 'view',
    outputs: [{type: 'address', name: '', internalType: 'contract OliveToken'}],
    name: 'olive',
    inputs: [],
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      {type: 'uint256', name: 'accOlivePerShare', internalType: 'uint256'},
    ],
    name: 'poolInfo',
...
async function main() {
  ...
  const rewardsPerWeek = (((await OLIVE_CHEF.olivePerBlock()) / 1e18) * 604800) / blocksPerSeconds

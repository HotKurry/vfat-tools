...
function printWasabixContractLinks(
  App,
  wasabixAbi,
  wasabixAddr,
  poolIndex,
...
async function main() {
  ...
  const poolInfos = await Promise.all(
    [...Array(poolCount / 1).keys()].map(async x => await getWasabixPoolInfo(App, WASABIX_POOL, x))
  )
  ...
  prices['0xfd8e70e83e399307db3978d3f34b060a06792c36']['usd'] =
    wbtcPrice['0x2260fac5e5542a773aa44fbcfedf7c193bc2c599']['usd']

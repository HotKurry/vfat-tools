...
const PASTA_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract PastaToken', name: '_pasta', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
      {internalType: 'address', name: '_feeAddress', type: 'address'},
      {internalType: 'uint256', name: '_pastaPerBlock', type: 'uint256'},
  ...
  },
  {
    inputs: [],
    name: 'pasta',
    outputs: [{internalType: 'contract PastaToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accPASTAPerShare', type: 'uint256'},
  ...
  {
    inputs: [{internalType: 'uint256', name: '_pastaPerBlock', type: 'uint256'}],
...
async function main() {
  ...
  const PASTA_CHEF_ADDR = '0x60b1bc3b8f753758cab89d4603bf5c901dd16eb4'
  const rewardTokenTicker = 'PASTA'
  const PASTA_CHEF = new ethers.Contract(PASTA_CHEF_ADDR, PASTA_CHEF_ABI, App.provider)

  const rewardsPerWeek = (((await PASTA_CHEF.pastaPerBlock()) / 1e18) * 604800) / 3

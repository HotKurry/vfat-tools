...
const YUMCHA_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract yumchaToken', name: '_yumcha', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
      {internalType: 'uint256', name: '_yumchaPerBlock', type: 'uint256'},
  ...
  },
  {
    ...
    inputs: [
      {indexed: true, internalType: 'address', name: 'user', type: 'address'},
      {indexed: false, internalType: 'uint256', name: 'yumchaPerBlock', type: 'uint256'},
    ],
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accyumchaPerShare', type: 'uint256'},
  ...
  },
  {
    inputs: [],
    name: 'yumcha',
    outputs: [{internalType: 'contract yumchaToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
...
async function main() {
  ...
  const rewardsPerWeek = (((await YUMCHA_CHEF.yumchaPerBlock()) / 1e18) * 604800) / 3

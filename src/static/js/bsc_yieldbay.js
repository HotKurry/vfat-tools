...
const PALM_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract PalmToken', name: '_cake', type: 'address'},
      {internalType: 'contract CoconutPalm', name: '_syrup', type: 'address'},
  ...
  },
  {
    inputs: [],
    name: 'cake',
    outputs: [{internalType: 'contract PalmToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    inputs: [],
    name: 'syrup',
    outputs: [{internalType: 'contract CoconutPalm', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
...
async function main() {
  ...
  const PALM_CHEF_ADDR = '0xf1530E2826920847Ba3Eaf9f60101Bf557332E67'
  const rewardTokenTicker = 'CAKE'
  const PALM_CHEF = new ethers.Contract(PALM_CHEF_ADDR, PALM_CHEF_ABI, App.provider)

  const rewardsPerWeek = (((await PALM_CHEF.cakePerBlock()) / 1e18) * 604800) / 3

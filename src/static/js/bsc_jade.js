...
const JADE_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract JadeToken', name: '_jade', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
      {internalType: 'address', name: '_feeAddress', type: 'address'},
      {internalType: 'uint256', name: '_jadePerBlock', type: 'uint256'},
  ...
  },
  {
    inputs: [],
    name: 'jade',
    outputs: [{internalType: 'contract JadeToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accJadePerShare', type: 'uint256'},
  ...
  {
    inputs: [{internalType: 'uint256', name: '_jadePerBlock', type: 'uint256'}],
...
async function main() {
  ...
  const rewardsPerWeek = (((await JADE_CHEF.jadePerBlock()) / 1e18) * 604800) / 3

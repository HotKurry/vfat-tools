...
const SPACE_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract FarmSpaceToken', name: '_space', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
      {internalType: 'uint256', name: '_spacePerBlock', type: 'uint256'},
  ...
  },
  {
    ...
    inputs: [
      {indexed: true, internalType: 'address', name: 'user', type: 'address'},
      {indexed: false, internalType: 'uint256', name: 'spacePerBlock', type: 'uint256'},
    ],
  ...
  {
    inputs: [{internalType: 'address', name: '_blackHole', type: 'address'}],
    name: 'blackhole',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accSpacePerShare', type: 'uint256'},
  ...
  },
  {
    inputs: [],
    name: 'space',
    outputs: [{internalType: 'contract FarmSpaceToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
...
async function main() {
  ...
  const SPACE_CHEF_ADDR = '0xc8cf0767fB2258b23B90636A5e21cfaD113e8182'
  const rewardTokenTicker = 'SPACE'
  const SPACE_CHEF = new ethers.Contract(SPACE_CHEF_ADDR, SPACE_CHEF_ABI, App.provider)

  const rewardsPerWeek = (((await SPACE_CHEF.spacePerBlock()) / 1e18) * 604800) / 3

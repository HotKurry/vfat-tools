...
const POOP_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract PoopToken', name: '_poop', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
      {internalType: 'address', name: '_feeAddress', type: 'address'},
      {internalType: 'uint256', name: '_poopPerBlock', type: 'uint256'},
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accPoopPerShare', type: 'uint256'},
  ...
  },
  {
    inputs: [],
    name: 'poop',
    outputs: [{internalType: 'contract PoopToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  {
    inputs: [{internalType: 'uint256', name: '_poopPerBlock', type: 'uint256'}],
    name: 'updateEmissionRate',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
...
async function main() {
  ...
  if (startBlock > currentBlock) {
    ...
    rewardsPerWeek = (((await POOP_CHEF.poopPerBlock()) / 1e18) * 604800) / 3

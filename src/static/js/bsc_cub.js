...
const CUB_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract CubToken', name: '_cub', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
      {internalType: 'address', name: '_feeAddress', type: 'address'},
      {internalType: 'uint256', name: '_cubPerBlock', type: 'uint256'},
  ...
  },
  {
    inputs: [],
    name: 'cub',
    outputs: [{internalType: 'contract CubToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accCubPerShare', type: 'uint256'},
  ...
  {
    inputs: [{internalType: 'uint256', name: '_cubPerBlock', type: 'uint256'}],
...
async function main() {
  ...
  const CUB_CHEF_ADDR = '0x227e79C83065edB8B954848c46ca50b96CB33E16'
  const rewardTokenTicker = 'CUB'
  const CUB_CHEF = new ethers.Contract(CUB_CHEF_ADDR, CUB_CHEF_ABI, App.provider)

  const rewardsPerWeek = (((await CUB_CHEF.cubPerBlock()) / 1e18) * 604800) / 3

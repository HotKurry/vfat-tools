...
async function main() {
  ...
  _print(
    `Your LP tokens comprise of ${q0user.toFixed(2)} ${poolPrices.t0.symbol} + ${q1user.toFixed(2)} ${
      poolPrices.t1.symbol
    }`
  )
  ...
  printAPR('USF', usfPrice, rewardsPerWeek, 'USF-ETH LP', poolPrices.tvl, lpToken.unstaked, poolPrices.price, 2)

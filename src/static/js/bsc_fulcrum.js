...
const BGOV_CHEF_ABI = [
  ...
  },
  {
    inputs: [],
    name: 'BGOV',
    outputs: [{internalType: 'contract BGovToken', name: '', type: 'address'}],
  ...
  },
  {
    ...
    outputs: [{internalType: 'uint256[2][]', name: 'userInfos', type: 'uint256[2][]'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
    ...
    outputs: [
      {
        components: [
          ...
          {internalType: 'uint256', name: 'accBGOVPerShare', type: 'uint256'},
        ],
  ...
  {
    inputs: [
      {internalType: 'contract BGovToken', name: '_BGOV', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
      {internalType: 'uint256', name: '_BGOVPerBlock', type: 'uint256'},
...
async function main() {
  ...
  if (currentBlock < bonusEndBlock) {
    rewardsPerWeek = ((((await BGOV_CHEF.BGOVPerBlock()) * bonusMultiplier) / 1e18) * 604800) / 3
  } else {
    rewardsPerWeek = (((await BGOV_CHEF.BGOVPerBlock()) / 1e18) * 604800) / 3
  }

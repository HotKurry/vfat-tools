...
const FRAX_STAKING_ABI = [
  {
    inputs: [
      ...
      {internalType: 'uint256', name: '_pool_weight0', type: 'uint256'},
      {internalType: 'uint256', name: '_pool_weight1', type: 'uint256'},
    ],
  ...
  {
    inputs: [{internalType: 'address', name: 'migrator_address', type: 'address'}],
    name: 'addMigrator',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {inputs: [], name: 'initializeDefault', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {
    inputs: [],
    name: 'lastPauseTime',
    outputs: [{internalType: 'uint256', name: '', type: 'uint256'}],
    ...
    outputs: [
      {
        ...
        internalType: 'struct StakingRewardsDualV2.LockedStake[]',
        name: '',
        type: 'tuple[]',
      },
    ],
  ...
  {
    inputs: [],
    name: 'locked_stake_max_multiplier',
    outputs: [{internalType: 'uint256', name: '', type: 'uint256'}],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    inputs: [],
    name: 'locked_stake_time_for_max_multiplier',
    outputs: [{internalType: 'uint256', name: '', type: 'uint256'}],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    ...
    name: 'migratorApprovedForStaker',
    outputs: [{internalType: 'bool', name: '', type: 'bool'}],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    inputs: [{internalType: 'address', name: 'staker_address', type: 'address'}],
    name: 'migrator_withdraw_unlocked',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  ...
  {inputs: [], name: 'renewIfApplicable', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {
    inputs: [],
    name: 'rewardPerToken',
    outputs: [
  ...
  {
    inputs: [
      {internalType: 'uint256', name: '_locked_stake_time_for_max_multiplier', type: 'uint256'},
      {internalType: 'uint256', name: '_locked_stake_min_time', type: 'uint256'},
    ],
  ...
  {
    inputs: [
      {internalType: 'uint256', name: '_locked_stake_max_multiplier', type: 'uint256'},
      {internalType: 'uint256', name: '_cr_boost_max_multiplier', type: 'uint256'},
    ],
    name: 'setMultipliers',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [{internalType: 'address', name: '_owner_address', type: 'address'}],
    name: 'setOwner',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [{internalType: 'address', name: '_new_timelock', type: 'address'}],
    name: 'setTimelock',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {inputs: [], name: 'toggleMigrations', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {inputs: [], name: 'toggleRewardsCollection', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {inputs: [], name: 'toggleToken1Rewards', outputs: [], stateMutability: 'nonpayable', type: 'function'},
...
async function main() {
  ...
  let p = await loadFraxSynthetixPools(
    App,
    tokens,
    prices,
    Pool.abi,
    Pool.address,
    Pool.RewardTokenFunction0,
    Pool.RewardTokenFunction1,
    Pool.stakingTokenFunction
  )
...
async function loadFraxSynthetixPoolsInfo(App, tokens, prices, stakingAbi, stakingAddress) {
  ...
  const calls = [
    STAKING_MULTI.stakingToken(),
    STAKING_MULTI.rewardsToken0(),
    STAKING_MULTI.rewardsToken1(),
    STAKING_MULTI.periodFinish(),
    STAKING_MULTI.rewardRate0(),
    STAKING_MULTI.rewardRate1(),
    STAKING_MULTI.balanceOf(App.YOUR_ADDRESS),
    STAKING_MULTI.rewards0(App.YOUR_ADDRESS),
    STAKING_MULTI.rewards1(App.YOUR_ADDRESS),
  ]
  const [
    stakeTokenAddress,
    rewardTokenAddress0,
  ...
  let newPriceAddresses = stakeToken.tokens
    .filter(x => !getParameterCaseInsensitive(prices, x))
    .concat([rewardTokenAddress0, rewardTokenAddress1])
  let newPrices = await lookUpTokenPrices(newPriceAddresses)
  for (const key in newPrices) {
    if (newPrices[key]?.usd) prices[key] = newPrices[key]
  }
  let newTokenAddresses = stakeToken.tokens.filter(x => !getParameterCaseInsensitive(tokens, x))
...
async function printFraxSynthetixPool(App, info, chain = 'eth') {
  ...
  _print(
    `${info.rewardTokenTicker0} APR: Day ${dailyAPR0.toFixed(2)}% Week ${weeklyAPR0.toFixed(
      2
    )}% Year ${yearlyAPR0.toFixed(2)}%`
  )
  ...
  _print(
    `${info.rewardTokenTicker1} APR: Day ${dailyAPR1.toFixed(2)}% Week ${weeklyAPR1.toFixed(
      2
    )}% Year ${yearlyAPR1.toFixed(2)}%`
  )
  ...
  if (info.userStaked > 0) {
    ...
    _print(
      `Estimated ${info.rewardTokenTicker0} earnings:` +
    ...
    _print(
      `Estimated ${info.rewardTokenTicker1} earnings:` +
  ...
  _print_link(
    `Claim ${info.earned0.toFixed(6)} ${info.rewardTokenTicker0} ($${formatMoney(
      info.earned0 * info.rewardTokenPrice0
    )})`,
    claim
  )

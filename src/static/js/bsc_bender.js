...
const BENDER_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract BenderToken', name: '_bender', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
      {internalType: 'address', name: '_feeAddress', type: 'address'},
      {internalType: 'uint256', name: '_benderPerBlock', type: 'uint256'},
  ...
  },
  {
    inputs: [],
    name: 'bender',
    outputs: [{internalType: 'contract BenderToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accBenderPerShare', type: 'uint256'},
  ...
  {
    inputs: [{internalType: 'uint256', name: '_benderPerBlock', type: 'uint256'}],
...
async function main() {
  ...
  const rewardTokenTicker = 'BENDER'
  const BENDER_CHEF = new ethers.Contract(BENDER_CHEF_ADDR, BENDER_CHEF_ABI, App.provider)

  const rewardsPerWeek = (((await BENDER_CHEF.benderPerBlock()) / 1e18) * 604800) / 3

...
async function loadPool(App, tokens, prices, stakingAbi, stakingAddress, rewardTokenFunction, stakeTokenFunction) {
  ...
  const allowance = stakeTokenFunction == 'lpt' ? userUnstaked : Math.min(tokenMax - userStaked, userUnstaked)
  const maxAllowance =
    stakeTokenFunction == 'lpt'
      ? null
      : ethers.BigNumber.from(tokenMax).mul(ethers.BigNumber.from('10').pow(stakeToken.decimals))
...
async function main() {
  const CONTRACTS = [
    {
      address: Contracts.DCC.DCSUSDT,
      abi: Contracts.DCC.STAKING_LPT_ABI,
      rewardToken: 'decentralizeShare',
      stakeToken: 'lpt',
    },
    {
      address: Contracts.DCC.DCCUSDT,
      abi: Contracts.DCC.STAKING_LPT_ABI,
      rewardToken: 'decentralizeShare',
      stakeToken: 'lpt',
    },
    {
      address: Contracts.DCC.USDT,
      abi: Contracts.DCC.STAKING_ABI,
      rewardToken: 'decentralizeCash',
      stakeToken: 'stakeToken',
    },
    {
      address: Contracts.DCC.USDC,
      abi: Contracts.DCC.STAKING_ABI,
      rewardToken: 'decentralizeCash',
      stakeToken: 'stakeToken',
    },
    {
      address: Contracts.DCC.DAI,
      abi: Contracts.DCC.STAKING_ABI,
      rewardToken: 'decentralizeCash',
      stakeToken: 'stakeToken',
    },
    {
      address: Contracts.DCC.BUSD,
      abi: Contracts.DCC.STAKING_ABI,
      rewardToken: 'decentralizeCash',
      stakeToken: 'stakeToken',
    },
    {
      address: Contracts.DCC.ESD,
      abi: Contracts.DCC.STAKING_ABI,
      rewardToken: 'decentralizeCash',
      stakeToken: 'stakeToken',
    },
    {
      address: Contracts.DCC.MIC,
      abi: Contracts.DCC.STAKING_ABI,
      rewardToken: 'decentralizeCash',
      stakeToken: 'stakeToken',
    },
    {
      address: Contracts.DCC.BAC,
      abi: Contracts.DCC.STAKING_ABI,
      rewardToken: 'decentralizeCash',
      stakeToken: 'stakeToken',
    },
    {
      address: Contracts.DCC.FRAX,
      abi: Contracts.DCC.STAKING_ABI,
      rewardToken: 'decentralizeCash',
      stakeToken: 'stakeToken',
    },
    {
      address: Contracts.DCC.WETH,
      abi: Contracts.DCC.STAKING_ABI,
      rewardToken: 'decentralizeCash',
      stakeToken: 'stakeToken',
    },

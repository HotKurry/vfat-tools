...
const KICK_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract KickToken', name: '_kick', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
      {internalType: 'address', name: '_feeAddress', type: 'address'},
      {internalType: 'uint256', name: '_kickPerBlock', type: 'uint256'},
  ...
  },
  {
    inputs: [],
    name: 'kick',
    outputs: [{internalType: 'contract KickToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accKickPerShare', type: 'uint256'},
  ...
  {
    inputs: [{internalType: 'uint256', name: '_kickPerBlock', type: 'uint256'}],
...
async function main() {
  ...
  const rewardsPerWeek = (((await KICK_CHEF.kickPerBlock()) / 1e18) * 604800) / 3

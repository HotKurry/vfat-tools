...
const BLUE_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract BlueToken', name: '_blue', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
      {internalType: 'address', name: '_feeAddress', type: 'address'},
      {internalType: 'uint256', name: '_bluePerBlock', type: 'uint256'},
  ...
  },
  {
    inputs: [],
    name: 'blue',
    outputs: [{internalType: 'contract BlueToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accBluePerShare', type: 'uint256'},
  ...
  {
    inputs: [{internalType: 'uint256', name: '_bluePerBlock', type: 'uint256'}],
...
async function main() {
  ...
  const rewardsPerWeek = (((await BLUE_CHEF.bluePerBlock()) / 1e18) * 604800) / 3

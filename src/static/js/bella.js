...
async function loadBellaContract(
  App,
  chef,
  chefAddress,
  chefAbi,
  ...
  const poolInfos = await Promise.all(
    [...Array(poolCount).keys()].map(
      async x => await getBellaPoolInfo(App, chefContract, chefAddress, x, pendingRewardsFunction)
    )
  )

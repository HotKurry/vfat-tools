...
const BVAULTS_CHEF_ABI = [
  ...
  },
  {
    anonymous: false,
    inputs: [
      {indexed: true, internalType: 'uint256', name: 'rewardPid', type: 'uint256'},
  ...
  },
  {
    inputs: [
      ...
      {internalType: 'uint256', name: '_bfiRewardRate', type: 'uint256'},
      {internalType: 'address', name: '_bdo', type: 'address'},
      {internalType: 'uint256', name: '_bdoRewardRate', type: 'uint256'},
    ],
    name: 'initialize',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    inputs: [
      {internalType: 'uint256', name: '_pid', type: 'uint256'},
      {internalType: 'uint256', name: '_rewardPid', type: 'uint256'},
  ...
  {
    inputs: [{internalType: 'uint256', name: '_unstakingFrozenTime', type: 'uint256'}],
...
const BVAULTS_STRATEGY_ABI = [
  {
    inputs: [
      {internalType: 'address', name: '_bvaultsBankAddress', type: 'address'},
      ...
      {internalType: 'address', name: '_buyBackToken1', type: 'address'},
      {internalType: 'address', name: '_buyBackAddress1', type: 'address'},
      {internalType: 'address', name: '_buyBackToken2', type: 'address'},
      {internalType: 'address', name: '_buyBackAddress2', type: 'address'},
    ],
    stateMutability: 'nonpayable',
    type: 'constructor',
  },
  {
    anonymous: false,
    inputs: [
      {indexed: false, internalType: 'address', name: 'earnedAddress', type: 'address'},
      {indexed: false, internalType: 'address', name: 'buyBackToken', type: 'address'},
      {indexed: false, internalType: 'uint256', name: 'earnedAmt', type: 'uint256'},
      {indexed: false, internalType: 'uint256', name: 'buyBackAmt', type: 'uint256'},
  ...
  },
  {
    anonymous: false,
    inputs: [
      {indexed: false, internalType: 'address', name: 'token0Address', type: 'address'},
      {indexed: false, internalType: 'uint256', name: 'token0Amt', type: 'uint256'},
      {indexed: false, internalType: 'address', name: 'token1Address', type: 'address'},
  ...
  {
    inputs: [{internalType: 'address', name: '_buyBackAddress1', type: 'address'}],
  ...
  {
    inputs: [{internalType: 'address', name: '_buyBackAddress2', type: 'address'}],
  ...
  {
    inputs: [{internalType: 'uint256', name: '_buyBackRate1', type: 'uint256'}],
  ...
  {
    inputs: [{internalType: 'uint256', name: '_buyBackRate2', type: 'uint256'}],
  ...
  {
    inputs: [{internalType: 'address[]', name: '_path', type: 'address[]'}],
  ...
  {
    inputs: [{internalType: 'bool', name: '_notPublic', type: 'bool'}],
    name: 'setNotPublic',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
...
async function loadBscBvaultsContract(App, tokens, prices, chef, chefAddress, chefAbi) {
  ...
  const rewardPools = await Promise.all([...Array(rewardPoolLength).keys()].map(i => getRewardPoolInfo(App, chef, i)))

  const poolInfos = await Promise.all(
    [...Array(poolCount).keys()].map(
      async i => await getBvaultsPoolInfo(App, chefContract, chefAddress, i, rewardPools)
    )
  )
...
function printBVaultsAPR(
  ...
  if (userStaked > 0) {
    for (let i = 0; i < rewardPools.length; i++) {
      ...
      _print(
        `Estimated ${rewardPools[i].rewardToken.symbol} earnings:` +
...
function printBvaultsContractLinks(
  App,
  chefAbi,
  chefAddr,
  poolInfo,

...
const POLAR_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract PolarisToken', name: '_polar', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
      {internalType: 'address', name: '_feeAddress', type: 'address'},
      {internalType: 'uint256', name: '_polarPerBlock', type: 'uint256'},
  ...
  },
  {
    inputs: [],
    name: 'polar',
    outputs: [{internalType: 'contract PolarisToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accPolarPerShare', type: 'uint256'},
  ...
  {
    inputs: [{internalType: 'uint256', name: '_polarPerBlock', type: 'uint256'}],

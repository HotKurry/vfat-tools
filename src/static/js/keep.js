...
const KEEP_CONTRACT_ABI = [
  {
    inputs: [
      {internalType: 'contract KeepToken', name: 'keepToken', type: 'address'},
      {internalType: 'contract IERC20', name: 'tbtcSaddleLPToken', type: 'address'},
    ],
    payable: false,
  ...
  {
    constant: false,
    inputs: [{internalType: 'bool', name: '_gated', type: 'bool'}],
    name: 'setGated',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
...
const KEEP_STAKING_ABI = [
  {
    inputs: [
      {internalType: 'contract KeepToken', name: '_keepToken', type: 'address'},
      ...
      {internalType: 'uint256', name: '_initialSharesPerToken', type: 'uint256'},
  ...
  },
  {
    anonymous: false,
    inputs: [
      {indexed: false, internalType: 'uint256', name: 'oldDurationSec', type: 'uint256'},
      {indexed: false, internalType: 'uint256', name: 'newDurationSec', type: 'uint256'},
    ],
  ...
  {
    constant: false,
    inputs: [{internalType: 'uint256', name: '_newDurationSec', type: 'uint256'}],
    name: 'setDurationSec',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
  ...
  {
    constant: false,
    inputs: [{internalType: 'address', name: 'newRewardDistribution', type: 'address'}],
    name: 'setRewardDistribution',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'lastUnlockTimestampSec', type: 'uint256'},
...
async function loadKeepVault(App, tokens, prices, STAKING_POOL, KEEP_TOKEN_ADDR, KEEP_STAKING_ADDR, KEEP_STAKING_ABI) {
  ...
  const yourStakedLP = (await STAKING_POOL.totalStakedFor(App.YOUR_ADDRESS)) / 1e18
...
function printKeepContractLinks(
  App,
  amount,
  chefAbi,
  chefAddr,

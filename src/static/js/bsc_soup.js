...
async function main() {
  ...
  await loadSoupExpiredChefContract(
    App,
    tokens,
    prices,
    SOUP_CHEF,
...
async function loadSoupExpiredChefContract(
  App,
  tokens,
  prices,
  chef,
...
function printSoupChefContractLinks(
  App,
  chefAbi,
  chefAddr,
  poolIndex,

...
const LAB_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract LaboToken', name: '_labo', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
      {internalType: 'address', name: '_feeAddress', type: 'address'},
      {internalType: 'uint256', name: '_laboPerBlock', type: 'uint256'},
    ],
  ...
  },
  {
    ...
    inputs: [
      {indexed: true, internalType: 'address', name: 'user', type: 'address'},
      {indexed: false, internalType: 'uint256', name: 'laboPerBlock', type: 'uint256'},
    ],
  ...
  },
  {
    inputs: [],
    name: 'labo',
    outputs: [{internalType: 'contract LaboToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accLaboPerShare', type: 'uint256'},
  ...
  {
    inputs: [{internalType: 'uint256', name: '_laboPerBlock', type: 'uint256'}],
    name: 'updateEmissionRate',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
...
async function main() {
  ...
  const LAB_CHEF_ADDR = '0x30f4cb706e65abb3cbc3ffc2805e8ff50ea8fbc8'
  const rewardTokenTicker = 'LABO'
  const LAB_CHEF = new ethers.Contract(LAB_CHEF_ADDR, LAB_CHEF_ABI, App.provider)

  const rewardsPerWeek = (((await LAB_CHEF.laboPerBlock()) / 1e18) * 604800) / 3

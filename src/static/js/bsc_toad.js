...
const TOAD_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract ToadToken', name: '_toad', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
      {internalType: 'address', name: '_feeAddress', type: 'address'},
      {internalType: 'uint256', name: '_toadPerBlock', type: 'uint256'},
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accToadPerShare', type: 'uint256'},
  ...
  },
  {
    inputs: [],
    name: 'toad',
    outputs: [{internalType: 'contract ToadToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  {
    inputs: [{internalType: 'uint256', name: '_toadPerBlock', type: 'uint256'}],
...
async function main() {
  ...
  const TOAD_CHEF_ADDR = '0xd390D438897852d378e9B807DAf41BE71C52F7fF'
  const rewardTokenTicker = 'TOAD'
  const TOAD_CHEF = new ethers.Contract(TOAD_CHEF_ADDR, TOAD_CHEF_ABI, App.provider)

  const rewardsPerWeek = (((await TOAD_CHEF.toadPerBlock()) / 1e18) * 604800) / 3

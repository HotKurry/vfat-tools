...
const PLUTUS_ABI = [
  {
    inputs: [
      {internalType: 'contract Polis', name: '_polis', type: 'address'},
      {internalType: 'contract Validator', name: '_val', type: 'address'},
      {internalType: 'uint256', name: '_polisPerBlock', type: 'uint256'},
  ...
  },
  {
    ...
    inputs: [
      ...
      {indexed: true, internalType: 'uint256', name: 'rid', type: 'uint256'},
      {indexed: false, internalType: 'uint256', name: 'amount', type: 'uint256'},
    ],
    name: 'DepositToken',
    type: 'event',
  ...
  {inputs: [], name: 'halving', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {inputs: [], name: 'massUpdateRewards', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {
    inputs: [],
    name: 'nextHalving',
    outputs: [{internalType: 'uint256', name: '', type: 'uint256'}],
  ...
  },
  {
    inputs: [],
    name: 'polis',
    outputs: [{internalType: 'contract Polis', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  {inputs: [], name: 'renounceOwnership', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accPolisPerShare', type: 'uint256'},
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    inputs: [
      ...
      {internalType: 'uint256', name: '_allocPoint', type: 'uint256'},
      {internalType: 'bool', name: 'isTreasury', type: 'bool'},
    ],
    name: 'setPercentage',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    inputs: [],
    name: 'validator',
    outputs: [{internalType: 'contract Validator', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
...
async function main() {
  ...
  const rewardsPerWeek = (((await PLUTUS.polisPerBlock()) / 1e18) * 604800) / 3

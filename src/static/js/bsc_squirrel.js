...
const FARM_ABI = [
  ...
  },
  {
    ...
    inputs: [
      ...
      {name: 'minNuts', type: 'uint256'},
      {name: 'percentBurnt', type: 'uint256'},
    ],
    name: 'sweepNuts',
    outputs: [],
    payable: false,
  ...
  {
    constant: false,
    inputs: [{name: 'newGov', type: 'address'}],
    name: 'updateGovenance',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
    constant: false,
    inputs: [{name: 'amount', type: 'uint256'}],
    name: 'withdrawAfterSystemClosed',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'function',
...
async function loadSquirrelContracts(App) {
  ...
  const tokens = {}
  tokens['0x8893D5fA71389673C5c4b9b3cb4EE1ba71207556'] = await getBscToken(
    App,
    '0x8893D5fA71389673C5c4b9b3cb4EE1ba71207556',
    '0x03d9d14367127d477e6f340c59e57ab088220187'
  )
  tokens['0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c'] = await getBscToken(
    App,
  ...
  // NUTS-BNB LP FARM
  const lpPool = await getBscToken(
    App,
    '0x034c9e6b08c09a6144e0d0e52161338fb105e656',
    '0x03d9d14367127d477e6f340c59e57ab088220187'
  )
  ...
  // NUTS FARM
  const nutsPool = await getBscToken(
    App,
    '0x8893D5fA71389673C5c4b9b3cb4EE1ba71207556',
    '0x45c12738c089224f66cd7a1c85301d79c45e2ded'
  )
  ...
  _print(
    `You are staking ${userNutsStaked.toFixed(2)} NUTS ($${formatMoney(
      userNutsStaked * nutsPrice
    )}), ${usersPercent.toFixed(2)}% of the pool.`
  )
  ...
  await outputVault(
    ...
    '0xdfd040cd6b1d7f15cad3094e3b49dc542fea77c1',
    '0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82',
    110,
    'CAKE',
    true
  ...
  await outputVault(
    ...
    '0xF397A390f008dbfC0fE995d9754acd8d137AA8dd',
    240,
    'BANANA',
    true
  )
  await outputVault(
    ...
    '0x55d1905c72365dcef69f9a7c890a26a2e3fc4c41',
    '0x25fd42D82d5c238ee7AA277261AA6CA5BDFE5CD4',
    160,
    'KEBAB',
    true
  )
  ...
  await outputFarm(
    ...
    '0x968c84d90bd4e1307333c7f98074d1b7caac497b',
  ...
  await outputFarm(
    ...
    '0xa9c72f556c1059500cf514ed10955bceaf227c4c',
  ...
  await outputFarm(
    ...
    '0x7456d4bda37d2aa5177ca1d8a494a318633b1fef',
    '0xF952Fc3ca7325Cc27D15885d37117676d25BfdA6',
    180,
    'EGG',
    true
  ...
  await outputFarm(
    ...
    nutsPrice,
    '0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82',
    '0x4d41a547cce57348e83493be0f4552a924e623a1',
    '0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82',
    100,
    'BRY',
    false
...
async function outputVault(
  ...
  if (lpToken != token) {
    // Load some missing tokens price from LP
  ...
  printCombinedAPR(
    nutsPrice,
    5000,
    tokenPrices.stakeTokenTicker,
    tokenPrices.staked_tvl,
    userStaked,
    tokenPrices.price,
    nativeAPR,
    nativeRewardTicker
...
async function printFarmActions(
  App,
  farm,
  token,
  userStaked,
  ...
  const approveAndStake = async function() {
    if (canApproveAndCall) {
      // Token supports single tx approveAndCall
...
async function printCombinedAPR(
  rewardPrice,
  poolRewardsPerWeek,
  stakeTokenTicker,
  staked_tvl,
...
async function approveAndCall(App, farm, token, unstaked) {
  ...
  showLoading()
  allow = token
    .approveAndCall(farm.address, userNuts, [], {gasLimit: 200000})
    .then(function(t) {
...
async function deposit(App, farm, token, unstaked, isVault) {
  ...
  if (allowedTokens / 1e18 < unstaked) {
    showLoading()
    allow = token
      .approve(farm.address, ethers.constants.MaxUint256)
      .then(function(t) {
        return App.provider.waitForTransaction(t.hash)
      })
      .catch(function(e) {
...
async function cashout(App, farm, isVault) {
  ...
  farm
    .cashout(userStaked.toString(), gas)
    .then(function(t) {
      return App.provider.waitForTransaction(t.hash)
    })
    .catch(function(e) {

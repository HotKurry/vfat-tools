...
const ZEFI_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract ZeFiToken', name: '_zefi', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
      {internalType: 'address', name: '_feeAddress', type: 'address'},
      {internalType: 'uint256', name: '_zefiPerBlock', type: 'uint256'},
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accZeFiPerShare', type: 'uint256'},
  ...
  {
    inputs: [{internalType: 'uint256', name: '_zefiPerBlock', type: 'uint256'}],
  ...
  },
  {
    inputs: [],
    name: 'zefi',
    outputs: [{internalType: 'contract ZeFiToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
...
async function main() {
  ...
  const ZEFI_CHEF_ADDR = '0x05a8ba2DEf87f8AdaF223Edcd04F7Fc82eA6aee8'
  const rewardTokenTicker = 'ZEFI'
  const ZEFI_CHEF = new ethers.Contract(ZEFI_CHEF_ADDR, ZEFI_CHEF_ABI, App.provider)

  const rewardsPerWeek = (((await ZEFI_CHEF.zefiPerBlock()) / 1e18) * 604800) / 3

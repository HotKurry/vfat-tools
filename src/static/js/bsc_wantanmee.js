...
const WANTANMEE_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'address', name: '_mee', type: 'address'},
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accMeePerShare', type: 'uint256'},
...
const WANTANMEES_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'address', name: '_mes', type: 'address'},
      {internalType: 'uint256', name: '_startBlock', type: 'uint256'},
    ],
    stateMutability: 'nonpayable',
    type: 'constructor',
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'allocPoint', type: 'uint256'},
      {internalType: 'uint256', name: 'lastRewardBlock', type: 'uint256'},
      {internalType: 'uint256', name: 'accMesPerShare', type: 'uint256'},
      {internalType: 'bool', name: 'isStarted', type: 'bool'},
    ],
    stateMutability: 'view',
    type: 'function',
...
const WANTANMEE_BOARDROOM_ABI = [
  ...
  {
    inputs: [
      {internalType: 'contract IERC20', name: '_mee', type: 'address'},
...
async function main() {
  ...
  const rewardsWantanmeePerWeek = (((await WANTANMEE_CHEF.rewardPerBlock()) / 1e18) * 604800) / 3
  const rewardsWantanmeeSharePerWeek = (((await WANTANMEES_CHEF.mesPerBlock()) / 1e18) * 604800) / 3
  ...
  await loadChefContract(
    ...
    WANTANMEE_CHEF_ADDR,
    WANTANMEE_CHEF_ABI,
    rewardWantanmeeTokenTicker,
    'mee',
    null,
    rewardsWantanmeePerWeek,
    'pendingReward',
    null,
    7
  )
  ...
  await loadChefContract(
    ...
    prices,
    WANTANMEES_CHEF,
    WANTANMEES_CHEF_ADDR,
    WANTANMEES_CHEF_ABI,
    rewardWantanmeeShareTokenTicker,
    'mes',
    null,
    rewardsWantanmeeSharePerWeek,
    'pendingReward',
    null,
    3
  )
  ...
  let br = await loadBoardroom(
    App,
    prices,
    WANTANMEES_BOARDROOM_ADDR,
    WANTANMEE_BOARDROOM_ORACLE_ADDR,
    lptAddress,
    rewardTokenAddress,
    stakeTicker,
    rewardTicker,

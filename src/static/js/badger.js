...
const DIGG_STRATEGY_ABI = [
  ...
  },
  {
    anonymous: false,
    inputs: [
      {indexed: false, internalType: 'uint256', name: 'totalDigg', type: 'uint256'},
      {indexed: false, internalType: 'uint256', name: 'totalShares', type: 'uint256'},
      {indexed: false, internalType: 'uint256', name: 'totalScaledShares', type: 'uint256'},
      {indexed: false, internalType: 'uint256', name: 'diggIncrease', type: 'uint256'},
      {indexed: false, internalType: 'uint256', name: 'sharesIncrease', type: 'uint256'},
      {indexed: false, internalType: 'uint256', name: 'scaledSharesIncrease', type: 'uint256'},
    ],
    name: 'HarvestState',
    type: 'event',
  },
  ...
  {
    anonymous: false,
    inputs: [{indexed: false, internalType: 'uint256', name: 'tended', type: 'uint256'}],
    name: 'Tend',
    type: 'event',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      {
        components: [
          {internalType: 'uint256', name: 'totalDigg', type: 'uint256'},
          {internalType: 'uint256', name: 'totalShares', type: 'uint256'},
          {internalType: 'uint256', name: 'totalScaledShares', type: 'uint256'},
          {internalType: 'uint256', name: 'diggIncrease', type: 'uint256'},
          {internalType: 'uint256', name: 'sharesIncrease', type: 'uint256'},
          {internalType: 'uint256', name: 'scaledSharesIncrease', type: 'uint256'},
        ],
        internalType: 'struct StrategyDiggRewards.HarvestData',
        name: '',
        type: 'tuple',
      },
    ],
  ...
  },
  {
    inputs: [
      ...
      {internalType: 'address', name: '_keeper', type: 'address'},
      {internalType: 'address', name: '_guardian', type: 'address'},
      {internalType: 'address[2]', name: '_wantConfig', type: 'address[2]'},
...
async function printPool(App, tokens, prices, pool, sharesPerFragment) {
  ...
  var newPriceAddresses = lpToken.tokens.filter(
    x =>
      x.toLowerCase() !== '0x075b1bb99792c9e1041ba13afef80c91a1e70fb3' && !getParameterCaseInsensitive(prices, x) //curve sBTC
  )
  var newPrices = await lookUpTokenPrices(newPriceAddresses)
  for (const key in newPrices) {
    if (newPrices[key]) prices[key] = newPrices[key]

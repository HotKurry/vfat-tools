...
const RUPEE_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract RupeeToken', name: '_rupee', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
      {internalType: 'address', name: '_feeAddress', type: 'address'},
      {internalType: 'uint256', name: '_rupeePerBlock', type: 'uint256'},
  ...
  {inputs: [], name: 'renounceOwnership', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {
    inputs: [],
    name: 'rupee',
    outputs: [{internalType: 'contract RupeeToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  {
    inputs: [{internalType: 'uint256', name: '_rupeePerBlock', type: 'uint256'}],
    name: 'updateEmissionRate',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
...
async function main() {
  ...
  const RUPEE_CHEF_ADDR = '0x76bd7145b99FDF84064A082BF86A33198C6e9D09'
  const rewardTokenTicker = 'RUPEE'
  const RUPEE_CHEF = new ethers.Contract(RUPEE_CHEF_ADDR, RUPEE_CHEF_ABI, App.provider)

  const rewardsPerWeek = (((await RUPEE_CHEF.rupeePerBlock()) / 1e18) * 604800) / 3

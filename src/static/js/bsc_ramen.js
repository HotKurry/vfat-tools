...
const RAMEN_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract RamenToken', name: '_cake', type: 'address'},
      {internalType: 'contract RamenSoup', name: '_syrup', type: 'address'},
  ...
  },
  {
    inputs: [],
    name: 'cake',
    outputs: [{internalType: 'contract RamenToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    inputs: [],
    name: 'syrup',
    outputs: [{internalType: 'contract RamenSoup', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
...
async function main() {
  ...
  const RAMEN_CHEF_ADDR = '0x97DD424B4628C8D3bD7fCf3A4e974Cebba011651'
  const rewardTokenTicker = 'RAMEN'
  const RAMEN_CHEF = new ethers.Contract(RAMEN_CHEF_ADDR, RAMEN_CHEF_ABI, App.provider)

  const rewardsPerWeek = (((await RAMEN_CHEF.cakePerBlock()) / 1e18) * 604800) / 3

...
async function main() {
  const DIAMOND_STAKING_ABI = [
    ...
    },
    {
      ...
      inputs: [
        ...
        {indexed: false, internalType: 'uint256', name: 'rebaseAmount', type: 'uint256'},
        {indexed: false, internalType: 'uint256', name: 'paidReward', type: 'uint256'},
      ],
      name: 'PayRewardPool',
      type: 'event',
    },
    {
      ...
      inputs: [
        {indexed: true, internalType: 'uint256', name: 'poolId', type: 'uint256'},
        {indexed: false, internalType: 'address', name: 'rewardMultiplier', type: 'address'},
      ],
    ...
    },
    {
      ...
      inputs: [
        {indexed: true, internalType: 'uint256', name: 'poolId', type: 'uint256'},
        {indexed: false, internalType: 'uint256', name: 'endRewardBlock', type: 'uint256'},
    ...
    },
    {
      ...
      inputs: [
        {indexed: true, internalType: 'uint256', name: 'poolId', type: 'uint256'},
        {indexed: false, internalType: 'address', name: 'rewardRebaser', type: 'address'},
      ],
    ...
    },
    {
      inputs: [
        ...
        {internalType: 'address', name: '_rewardRebaser', type: 'address'},
        {internalType: 'address', name: '_rewardMultiplier', type: 'address'},
        {internalType: 'uint256', name: '_startBlock', type: 'uint256'},
        {internalType: 'uint256', name: '_endRewardBlock', type: 'uint256'},
        {internalType: 'uint256', name: '_rewardPerBlock', type: 'uint256'},
        {internalType: 'uint256', name: '_lockRewardPercent', type: 'uint256'},
        {internalType: 'uint256', name: '_startVestingBlock', type: 'uint256'},
        {internalType: 'uint256', name: '_endVestingBlock', type: 'uint256'},
      ],
      name: 'addRewardPool',
      outputs: [],
      stateMutability: 'nonpayable',
    ...
    {
      inputs: [{internalType: 'uint8', name: 'pid', type: 'uint8'}],
      name: 'getRewardPerBlock',
      outputs: [{internalType: 'uint256', name: '', type: 'uint256'}],
      stateMutability: 'view',
      type: 'function',
    },
    {
      inputs: [
        {internalType: 'uint8', name: '_pid', type: 'uint8'},
        {internalType: 'address', name: '_rewardToken', type: 'address'},
        {internalType: 'uint256', name: '_pendingReward', type: 'uint256'},
      ],
    ...
    },
    {
      ...
      outputs: [
        ...
        {internalType: 'uint256', name: 'lockReward', type: 'uint256'},
    ...
    },
    {
      inputs: [
        ...
        {internalType: 'uint256', name: '_unstakingFrozenTime', type: 'uint256'},
        {internalType: 'address', name: '_rewardFund', type: 'address'},
    ...
    },
    {
      ...
      outputs: [
        ...
        {internalType: 'address', name: 'rewardRebaser', type: 'address'},
        {internalType: 'address', name: 'rewardMultiplier', type: 'address'},
        {internalType: 'uint256', name: 'startRewardBlock', type: 'uint256'},
        {internalType: 'uint256', name: 'lastRewardBlock', type: 'uint256'},
        {internalType: 'uint256', name: 'endRewardBlock', type: 'uint256'},
        {internalType: 'uint256', name: 'rewardPerBlock', type: 'uint256'},
        {internalType: 'uint256', name: 'accRewardPerShare', type: 'uint256'},
        {internalType: 'uint256', name: 'lockRewardPercent', type: 'uint256'},
        {internalType: 'uint256', name: 'startVestingBlock', type: 'uint256'},
        {internalType: 'uint256', name: 'endVestingBlock', type: 'uint256'},
        {internalType: 'uint256', name: 'numOfVestingBlocks', type: 'uint256'},
    ...
    {inputs: [], name: 'updateReward', outputs: [], stateMutability: 'nonpayable', type: 'function'},
    {
      inputs: [
        {internalType: 'uint8', name: '_pid', type: 'uint8'},
        {internalType: 'address', name: '_rewardMultiplier', type: 'address'},
  ...
  prices['0x4101fe75f547a65f6bb054a35f027c16562a45c3'] = getParameterCaseInsensitive(
    prices,
    '0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c'
  ) //dBNB
  prices['0x6b77f51d4c474efb15b72b829e6a0806bbc33724'] = getParameterCaseInsensitive(
    prices,
  ...
  for (const a of diamondPoolAddresses) {
    ...
    let p = await loadDiamondChefContract(
      App,
      tokens,
      prices,
      DIAMOND_CHEF,
...
async function loadDiamondChefContract(
  App,
  tokens,
  prices,
  chef,
  ...
  const poolInfos = await Promise.all(
    [...Array(poolCount).keys()].map(
      async x => await getBscDiamondPoolInfo(App, chefContract, chefAddress, x, pendingRewardsFunction)
    )
  )
  ...
  for (i = 0; i < poolCount; i++) {
    if (poolPrices[i]) {
      const apr = printDiamondChefPool(
        App,
        chefAbi,
        chefAddress,
        prices,
...
function printDiamondChefContractLinks(
  App,
  chefAbi,
  chefAddr,
  poolIndex,

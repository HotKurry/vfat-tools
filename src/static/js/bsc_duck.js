...
const DUCK_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract Duck', name: '_egg', type: 'address'},
  ...
  },
  {
    inputs: [],
    name: 'egg',
    outputs: [{internalType: 'contract Duck', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
...
async function main() {
  ...
  const rewardsPerWeek = (((await DUCK_CHEF.eggPerBlock()) / 1e18) * 604800) / 3

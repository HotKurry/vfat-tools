...
const STRUDEL_CHEF_ABI = [
  ...
  },
  {
    inputs: [
      ...
      {internalType: 'uint256', name: 'windowSize_', type: 'uint256'},
      {internalType: 'uint8', name: 'granularity_', type: 'uint8'},
    ],
    name: 'initVariance',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [
      {internalType: 'address', name: '_strudel', type: 'address'},
      {internalType: 'uint256', name: '_strudelPerBlock', type: 'uint256'},
      {internalType: 'uint256', name: '_startBlock', type: 'uint256'},
      {internalType: 'uint256', name: '_lastBlockHeight', type: 'uint256'},
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accStrudelPerShare', type: 'uint256'},
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    inputs: [{internalType: 'uint256', name: '_strudelPerBlock', type: 'uint256'}],
    name: 'setStrudelPerBlock',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  ...
  {inputs: [], name: 'updateVariance', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {
    inputs: [
...
async function loadStrudelChefContract(
  App,
  chefAddress,
  chefAbi,
  chefContract,
...
async function loadStrudelChefPools(
  App,
  prices,
  tokens,
  rewardTokenPoolIndex,
...
async function loadStrudelChefPool(
  App,
  prices,
  tokens,
  poolIndex,

...
async function main() {
  ...
  const DAO = new ethers.Contract(Contracts.BSC_SPAD.DAO.address, Contracts.BSC_SPAD.DAO.abi, App.provider)
  const DOLLAR = new ethers.Contract(Contracts.BSC_SPAD.Dollar.address, ERC20_ABI, App.provider)
  ...
  const [epoch, uniPrices, totalBonded] = await loadDAO(
    ...
    DAO,
    DOLLAR,
    Contracts.BSC_SPAD.UniswapLP.address,
    Contracts.BSC_SPAD.LPIncentivizationPool.address,
    tokens,
    prices,
  ...
  const LP = new ethers.Contract(
    Contracts.BSC_SPAD.LPIncentivizationPool.address,
    Contracts.BSC_SPAD.LPIncentivizationPool.abi,
    App.provider
  )

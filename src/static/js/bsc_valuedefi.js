...
const stakingAbi = [
  ...
  {
    inputs: [
      {internalType: 'address', name: '_vbswapToken', type: 'address'},
  ...
  {
    inputs: [{internalType: 'address', name: '_exchangeProxy', type: 'address'}],
    name: 'setExchangeProxy',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  ...
  {
    inputs: [{internalType: 'uint256', name: '_reservePercent', type: 'uint256'}],
  ...
  },
  {
    inputs: [],
    name: 'vbswapToken',
    outputs: [{internalType: 'contract vBSWAP', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
...
const vSafeABI = [
  ...
  {
    inputs: [{internalType: 'address', name: '_input', type: 'address'}],
    name: 'accept',
    outputs: [{internalType: 'bool', name: '', type: 'bool'}],
    stateMutability: 'view',
    type: 'function',
  ...
  {
    inputs: [
      {internalType: 'uint256', name: '_newCompound', type: 'uint256'},
      {internalType: 'uint256', name: '_blocksToReleaseCompound', type: 'uint256'},
    ],
    name: 'addNewCompound',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    ...
    name: 'depositFor',
    outputs: [{internalType: 'uint256', name: '_mint_amount', type: 'uint256'}],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
  ...
  {inputs: [], name: 'harvestAllStrategies', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {
  ...
  {
    inputs: [
      {internalType: 'contract IERC20', name: '_basedToken', type: 'address'},
      {internalType: 'contract IVaultMaster', name: '_vaultMaster', type: 'address'},
    ],
    name: 'initialize',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [],
    name: 'pendingCompound',
    outputs: [{internalType: 'uint256', name: '', type: 'uint256'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
    inputs: [{internalType: 'bool', name: '_acceptContractDepositor', type: 'bool'}],
  ...
  {
    inputs: [{internalType: 'bool', name: '_openHarvest', type: 'bool'}],
    name: 'setOpenHarvest',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [{internalType: 'contract IVaultMaster', name: '_vaultMaster', type: 'address'}],
    name: 'setVaultMaster',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [],
    name: 'startReleasingCompoundBlk',
    outputs: [{internalType: 'uint256', name: '', type: 'uint256'}],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    inputs: [
      ...
      {internalType: 'uint256', name: '_min_output_amount', type: 'uint256'},
    ],
    name: 'withdraw',
    outputs: [{internalType: 'uint256', name: '', type: 'uint256'}],
    stateMutability: 'nonpayable',
  ...
  },
  {
    ...
    name: 'withdrawFor',
    outputs: [{internalType: 'uint256', name: '_output_amount', type: 'uint256'}],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
  ...
  for (const pool of data) {
    try {
      ...
      if (userStaked > 0) {
        ...
        _print(`Est earning: ` + `Daily  $${formatMoney(dailyReward)}  ` + `Yearly $${formatMoney(yearlyReward)} `)
      }
      _print_link(
        `Approve ${parseFloat(stakedTokenBalance / 10 ** decimal).toFixed(8)}  ${stakingTokenTicker}`,
        approveFunc

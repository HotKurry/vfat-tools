...
const KBN_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract Koban', name: '_koban', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
      {internalType: 'uint256', name: '_kobanPerBlock', type: 'uint256'},
  ...
  {inputs: [], name: 'CONOVA', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {
    inputs: [],
    name: 'FrillishBlock',
    outputs: [{internalType: 'uint256', name: '', type: 'uint256'}],
  ...
  },
  {
    inputs: [
      ...
      {internalType: 'uint16', name: '_depositBP', type: 'uint16'},
  ...
  {inputs: [], name: 'claimREM', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {
    inputs: [
  ...
  },
  {
    inputs: [],
    name: 'koban',
    outputs: [{internalType: 'contract Koban', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  {inputs: [], name: 'niantic', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {
    inputs: [],
    name: 'owner',
    outputs: [{internalType: 'address', name: '', type: 'address'}],
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accKobanPerShare', type: 'uint256'},
      {internalType: 'uint16', name: 'depositBP', type: 'uint16'},
  ...
  {
    inputs: [{internalType: 'address', name: '_n1', type: 'address'}],
    name: 'setBP',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [{internalType: 'contract IBEP20', name: '_n1', type: 'address'}],
    name: 'setN1Trace',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {inputs: [], name: 'stackREM', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {
    inputs: [],
    name: 'startBlock',
    outputs: [{internalType: 'uint256', name: '', type: 'uint256'}],
  ...
  {
    inputs: [{internalType: 'uint256', name: '_kobanPerBlock', type: 'uint256'}],
    name: 'updateKobanPerBlock',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
...
const KBN_CHEF_ABI2 = [
  {
    inputs: [
      {internalType: 'contract IBEP20', name: '_koban', type: 'address'},
      ...
      {internalType: 'uint16', name: '_wbp', type: 'uint16'},
      {internalType: 'address', name: '_bp', type: 'address'},
      {internalType: 'address payable', name: '_pr', type: 'address'},
    ],
    stateMutability: 'nonpayable',
    type: 'constructor',
  },
  ...
  {
    inputs: [{internalType: 'address payable', name: '_est', type: 'address'}],
    name: 'EST',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [
      {internalType: 'contract IBEP20', name: '_eip', type: 'address'},
      {internalType: 'address payable', name: '_of', type: 'address'},
      {internalType: 'uint256', name: '_ct', type: 'uint256'},
    ],
    name: 'Exodus',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [{internalType: 'address', name: '_native', type: 'address'}],
    name: 'addNative',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {inputs: [], name: 'invokeNative', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {
    inputs: [],
    name: 'koban',
    outputs: [{internalType: 'contract IBEP20', name: '', type: 'address'}],
  ...
  {
    inputs: [{internalType: 'bool', name: '_ifi', type: 'bool'}],
    name: 'setLanding',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [{internalType: 'uint16', name: '_wbp', type: 'uint16'}],
    name: 'setWithBP',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {inputs: [], name: 'wardReward', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {
    inputs: [],
    name: 'withBP',
...
async function main() {
  ...
  const rewardsPerWeek = (((await KBN_CHEF.kobanPerBlock()) / 1e18) * 604800) / 3

  const rewardsPerWeek2 = (((await KBN_CHEF2.rewardPerBlock()) / 1e18) * 604800) / 3
...
async function loadBscNFTChefContract(
  App,
  tokens,
  prices,
  chef,
  ...
  const poolInfos = await Promise.all(
    [...Array(poolCount).keys()].map(
      async x => await getBscNFTPoolInfo(App, chefContract, chefAddress, x, pendingRewardsFunction)
    )
  )

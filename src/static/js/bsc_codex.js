...
const CDO_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract CodexToken', name: '_codex', type: 'address'},
  ...
  },
  {
    inputs: [],
    name: 'codex',
    outputs: [{internalType: 'contract CodexToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accCodexPerShare', type: 'uint256'},
    ],
    stateMutability: 'view',
    type: 'function',
  },
...
async function main() {
  ...
  const rewardsPerWeek = (((await CDO_CHEF.codexPerBlock()) / 1e18) * 604800) / 3
...
async function loadBscChefContract(
  ...
  var tokens = {}
  prices['0xa900A6291d3A49B1b555b40bd6277D56228B690b'] = getParameterCaseInsensitive(
    prices,
    '0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c'
  ) //flexBNB price
  prices['0xC37d72b7A3363d418e9374d73151164AB588406D'] = getParameterCaseInsensitive(
    prices,
    '0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56'
  ) //flexBUSD price
  prices['0xC82d3404fFC5f51F3E67BC9846ff0180d3c48178'] = getParameterCaseInsensitive(
    prices,
  ...
  const poolInfos = await Promise.all(
    [...Array(poolCount).keys()].map(
      async x => await getBscCdoPoolInfo(App, chefContract, chefAddress, x, pendingRewardsFunction)
    )
  )

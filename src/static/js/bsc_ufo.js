...
const UFO_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract UFOToken', name: '_ufo', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
      {internalType: 'address', name: '_feeAddress', type: 'address'},
      {internalType: 'uint256', name: '_ufoPerBlock', type: 'uint256'},
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accUFOPerShare', type: 'uint256'},
  ...
  },
  {
    inputs: [],
    name: 'ufo',
    outputs: [{internalType: 'contract UFOToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  {
    inputs: [{internalType: 'uint256', name: '_ufoPerBlock', type: 'uint256'}],
...
async function main() {
  ...
  const UFO_CHEF_ADDR = '0x95d9a00087f0db9e72b4014017842336480a153b'
  const rewardTokenTicker = 'UFO'
  const UFO_CHEF = new ethers.Contract(UFO_CHEF_ADDR, UFO_CHEF_ABI, App.provider)

  const rewardsPerWeek = (((await UFO_CHEF.ufoPerBlock()) / 1e18) * 604800) / 3

...
const FED_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract FedToken', name: '_fed', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
      {internalType: 'address', name: '_feeAddress', type: 'address'},
      {internalType: 'uint256', name: '_fedPerBlock', type: 'uint256'},
  ...
  },
  {
    inputs: [],
    name: 'fed',
    outputs: [{internalType: 'contract FedToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accFedPerShare', type: 'uint256'},
  ...
  {
    inputs: [{internalType: 'uint256', name: '_fedPerBlock', type: 'uint256'}],
...
async function main() {
  ...
  const rewardsPerWeek = (((await FED_CHEF.fedPerBlock()) / 1e18) * 604800) / 3

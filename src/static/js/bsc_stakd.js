...
const STAKD_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract STAKDToken', name: '_stakd', type: 'address'},
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accstakdPerShare', type: 'uint256'},
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    inputs: [],
    name: 'stakd',
    outputs: [{internalType: 'contract STAKDToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
...
async function main() {
  ...
  const rewardsPerWeek = (((await STAKD_CHEF.stakdPerBlock()) / 1e18) * 604800) / 3

...
const XWIN_CHEF_ABI = [
  {
    inputs: [
      ...
      {internalType: 'address', name: '_xwinBenefitPool', type: 'address'},
      {internalType: 'address', name: '_stakeAddress', type: 'address'},
      {internalType: 'address', name: '_xWinToken', type: 'address'},
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      {indexed: true, internalType: 'address', name: 'toFund', type: 'address'},
      {indexed: false, internalType: 'address[]', name: 'newTargets', type: 'address[]'},
      {indexed: false, internalType: 'uint256[]', name: 'newWeight', type: 'uint256[]'},
      {indexed: false, internalType: 'uint256', name: 'txnTime', type: 'uint256'},
    ],
    name: '_CreateTarget',
    type: 'event',
  },
  ...
  },
  {
    ...
    inputs: [
      ...
      {indexed: false, internalType: 'uint256', name: 'amount', type: 'uint256'},
      {indexed: false, internalType: 'uint256', name: 'swapOutput', type: 'uint256'},
    ],
  ...
  },
  {
    ...
    inputs: [
      {indexed: true, internalType: 'address', name: 'from', type: 'address'},
      {indexed: true, internalType: 'address', name: 'toFund', type: 'address'},
      {indexed: false, internalType: 'uint256', name: 'baseBalance', type: 'uint256'},
      {indexed: false, internalType: 'uint256', name: 'txnTime', type: 'uint256'},
    ],
  ...
  },
  {
    ...
    inputs: [
      {indexed: true, internalType: 'address', name: 'from', type: 'address'},
      {indexed: true, internalType: 'address', name: 'toFund', type: 'address'},
      {indexed: false, internalType: 'uint256', name: 'redeemUnit', type: 'uint256'},
      {indexed: false, internalType: 'uint256', name: 'rewardQty', type: 'uint256'},
      {indexed: false, internalType: 'uint256', name: 'redeemratio', type: 'uint256'},
    ],
    name: '_Redeem',
    type: 'event',
  },
  ...
  },
  {
    ...
    inputs: [
      {indexed: true, internalType: 'address', name: 'from', type: 'address'},
      {indexed: true, internalType: 'address', name: 'toFund', type: 'address'},
      {indexed: false, internalType: 'uint256', name: 'subsAmt', type: 'uint256'},
      {indexed: false, internalType: 'uint256', name: 'mintQty', type: 'uint256'},
    ],
    name: '_Subscribe',
    type: 'event',
  },
  ...
  {
    inputs: [
      {internalType: 'address[]', name: '_toAddresses', type: 'address[]'},
      {internalType: 'uint256[]', name: '_targetWeight', type: 'uint256[]'},
      {internalType: 'address', name: 'xFundAddress', type: 'address'},
    ],
    name: 'CreateTarget',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [{internalType: 'address', name: 'fromAddress', type: 'address'}],
  ...
  },
  {
    inputs: [
      ...
      {internalType: 'uint256', name: 'priceImpactTolerance', type: 'uint256'},
    ],
  ...
  {
    inputs: [
      {internalType: 'address', name: '_newProtocol', type: 'address'},
    ...
    inputs: [
      {
        components: [
          ...
          {internalType: 'uint256', name: 'priceImpactTolerance', type: 'uint256'},
          {internalType: 'uint256', name: 'deadline', type: 'uint256'},
          {internalType: 'bool', name: 'returnInBase', type: 'bool'},
          {internalType: 'address', name: 'referral', type: 'address'},
        ],
        internalType: 'struct xWinLib.TradeParams',
        name: '_tradeParams',
        type: 'tuple',
      },
      {internalType: 'address[]', name: '_toAddresses', type: 'address[]'},
  ...
  },
  {
    inputs: [
      ...
      {internalType: 'bool[]', name: '_isxwinFund', type: 'bool[]'},
    ],
    name: 'addxwinFund',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [{internalType: 'uint256', name: '_managerRewardperunit', type: 'uint256'}],
  ...
  {
    inputs: [{internalType: 'uint256', name: 'newPlatformFee', type: 'uint256'}],
  ...
  {
    inputs: [{internalType: 'uint256', name: '_referralperunit', type: 'uint256'}],
  ...
  {
    inputs: [{internalType: 'uint256', name: '_newRemaining', type: 'uint256'}],
  ...
  {
    inputs: [{internalType: 'address', name: 'newStakeProtocol', type: 'address'}],
  ...
  {
    inputs: [{internalType: 'address', name: '_xwinBenefitPool', type: 'address'}],
  ...
  },
  {
    ...
    outputs: [
      {internalType: 'uint256', name: 'blockstart', type: 'uint256'},
      {internalType: 'uint256', name: 'accBasetoken', type: 'uint256'},
      {internalType: 'uint256', name: 'accMinttoken', type: 'uint256'},
      {internalType: 'uint256', name: 'previousRealizedQty', type: 'uint256'},
    ],
    stateMutability: 'view',
    type: 'function',
  },
...
async function loadXwinChefContract(
  App,
  tokens,
  prices,
  chef,
...
async function getBscXwinPoolInfo(
  App,
  chefContract,
  chefAddress,
  poolIndex,

...
const XTOKEN_ABI = [
  ...
  },
  {
    ...
    inputs: [
      ...
      {internalType: 'address', name: '_rewardEscrow', type: 'address'},
    ],
    name: 'initialize',
    outputs: [],
    payable: false,
  ...
  },
  {
    ...
    inputs: [],
    name: 'rewardEscrow',
    outputs: [{internalType: 'contract RewardEscrow', name: '', type: 'address'}],
    payable: false,
    stateMutability: 'view',
    type: 'function',
  },
...
async function main() {
  ...
  _print('*** Important ***')
  _print(
    'Please do not use the Claim function as it will fail. To claim your rewards you need to use Exit, you can then Stake again.\n'
  )

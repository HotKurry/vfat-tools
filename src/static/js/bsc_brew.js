...
const BREW_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract CoffeeToken', name: '_cake', type: 'address'},
      {internalType: 'contract CafeBar', name: '_syrup', type: 'address'},
  ...
  },
  {
    inputs: [],
    name: 'cake',
    outputs: [{internalType: 'contract CoffeeToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    inputs: [],
    name: 'syrup',
    outputs: [{internalType: 'contract CafeBar', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
...
async function main() {
  ...
  const rewardsPerWeek = (((await BREW_CHEF.cakePerBlock()) / 1e18) * 604800) / 3

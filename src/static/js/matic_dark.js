...
const DARK_CHEF_ABI = [
  ...
  {type: 'function', stateMutability: 'nonpayable', outputs: [], name: 'fire', inputs: []},
  {
    type: 'function',
    stateMutability: 'view',
    outputs: [{type: 'uint256', name: '', internalType: 'uint256'}],
    name: 'getDB_DUSD_Pool_stakedDB',
  ...
  },
  {
    ...
    stateMutability: 'view',
    outputs: [{type: 'uint256', name: '', internalType: 'uint256'}],
    name: 'getDB_RDUSD_Pool_stakedDB',
    inputs: [{type: 'uint256', name: 'amount', internalType: 'uint256'}],
  },
  {
    type: 'function',
  ...
  },
  {
    ...
    outputs: [
      ...
      {type: 'uint256', name: 'accSakePerShare', internalType: 'uint256'},
    ],
    name: 'poolInfo',
  ...
  {type: 'function', stateMutability: 'nonpayable', outputs: [], name: 'renounceOwnership', inputs: []},
  {
    type: 'function',
    stateMutability: 'view',
    outputs: [{type: 'address', name: '', internalType: 'contract SakeToken'}],
    name: 'sake',
    inputs: [],
  },
  {
  ...
  {type: 'function', stateMutability: 'nonpayable', outputs: [], name: 'toggletrackingsnapshot', inputs: []},
  {
    type: 'function',
    stateMutability: 'view',
    outputs: [{type: 'uint256', name: '', internalType: 'uint256'}],
...
async function main() {
  ...
  const rewardsPerWeek = (((await DARK_CHEF.sakePerBlock()) / 1e18) * 604800) / 3

...
const BAMBOO_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contractSushiToken', name: '_bamboo', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
      {internalType: 'uint256', name: '_bambooPerBlock', type: 'uint256'},
  ...
  },
  {
    inputs: [],
    name: 'bamboo',
    outputs: [{internalType: 'contractSushiToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
...
async function main() {
  ...
  const rewardsPerWeek = (((await BAMBOO_CHEF.bambooPerBlock()) / 1e18) * 604800) / blocksPerSeconds

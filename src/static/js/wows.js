...
const WOWS_FARMING_ABI = [
  ...
  {
    anonymous: false,
    inputs: [{indexed: false, internalType: 'address', name: 'newController', type: 'address'}],
  ...
  },
  {
    ...
    name: 'getUIData',
    outputs: [{internalType: 'uint256[9]', name: '', type: 'uint256[9]'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
...
async function loadWowsPoolInfo(App, tokens, prices, stakingAbi, stakingAddress, tokenAddress, stakeTokenFunction) {

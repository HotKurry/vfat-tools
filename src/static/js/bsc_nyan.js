...
async function main() {
  ...
  const NYAN_CHEF_ADDR = '0xC885b97220ad6a8dfE4AC7aF7C7A4776c7A21f06'
  const rewardTokenTicker = 'NYAN'
  const NYAN_CHEF = new ethers.Contract(NYAN_CHEF_ADDR, NYAN_CHEF_ABI, App.provider)

  const rewardsPerWeek = (((await NYAN_CHEF.cakePerBlock()) / 1e18) * 604800) / 3

...
const DBALL_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract DBallToken', name: '_dball', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
      {internalType: 'address', name: '_feeAddress', type: 'address'},
      {internalType: 'uint256', name: '_dballPerBlock', type: 'uint256'},
  ...
  },
  {
    inputs: [
      ...
      {internalType: 'uint16', name: '_unstakingFeeBP', type: 'uint16'},
  ...
  },
  {
    inputs: [],
    name: 'dball',
    outputs: [{internalType: 'contract DBallToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint16', name: 'unstakingFeeBP', type: 'uint16'},
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    inputs: [{internalType: 'uint256', name: '_dballPerBlock', type: 'uint256'}],
...
async function main() {
  ...
  const rewardsPerWeek = (((await DBALL_CHEF.dballPerBlock()) / 1e18) * 604800) / 3

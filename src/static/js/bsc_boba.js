...
const BOBA_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract BobaToken', name: '_boba', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
      {internalType: 'address', name: '_feeAddress', type: 'address'},
      {internalType: 'uint256', name: '_bobaPerBlock', type: 'uint256'},
  ...
  },
  {
    inputs: [],
    name: 'boba',
    outputs: [{internalType: 'contract BobaToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accBobaPerShare', type: 'uint256'},
  ...
  {
    inputs: [{internalType: 'uint256', name: '_bobaPerBlock', type: 'uint256'}],
...
async function main() {
  ...
  const rewardsPerWeek = (((await BOBA_CHEF.bobaPerBlock()) / 1e18) * 604800) / 3

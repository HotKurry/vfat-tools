...
const MILK_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract MilkToken', name: '_milk', type: 'address'},
      {internalType: 'contract FoamBar', name: '_foam', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
      {internalType: 'uint256', name: '_milkPerBlock', type: 'uint256'},
  ...
  {inputs: [], name: 'massUpdatePools', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {
    inputs: [],
    name: 'milk',
    outputs: [{internalType: 'contract MilkToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accMilkPerShare', type: 'uint256'},
    ],
    stateMutability: 'view',
    type: 'function',
  },
...
async function main() {
  ...
  const MILK_CHEF_ADDR = '0xd3c61cf8de84e6b4b5db7e25739b8435860b84e3'
  const rewardTokenTicker = 'MILK'
  const MILK_CHEF = new ethers.Contract(MILK_CHEF_ADDR, MILK_CHEF_ABI, App.provider)

  const rewardsPerWeek = (((await MILK_CHEF.milkPerBlock()) / 1e18) * 604800) / 3

...
const TAO_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract TaoToken', name: '_tao', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
      {internalType: 'uint256', name: '_taoPerBlock', type: 'uint256'},
  ...
  },
  {
    inputs: [],
    name: 'TAO',
    outputs: [{internalType: 'contract TaoToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accTaoPerShare', type: 'uint256'},
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    inputs: [{internalType: 'uint256', name: '_taoPerBlock', type: 'uint256'}],
...
async function main() {
  ...
  await loadBscFrictionChefContract(
    App,
    tokens,
    prices,
    TAO_CHEF,
...
async function loadBscFrictionChefContract(
  App,
  tokens,
  prices,
  chef,
  ...
  for (i = 0; i < poolCount; i++) {
    if (poolPrices[i]) {
      const apr = printFrictionChefPool(
        App,
        chefAbi,
        chefAddress,
        prices,
...
function printFrictionChefPool(
  App,
  chefAbi,
  chefAddr,
  prices,
  ...
  printFrictionChefContractLinks(
    App,
    chefAbi,
    chefAddr,
    poolIndex,
...
function printFrictionChefContractLinks(
  App,
  chefAbi,
  chefAddr,
  poolIndex,

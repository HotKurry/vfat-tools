...
const VLAD_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract LifeToken', name: '_life', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
      {internalType: 'address', name: '_feeAddress', type: 'address'},
      {internalType: 'uint256', name: '_lifePerBlock', type: 'uint256'},
  ...
  },
  {
    inputs: [],
    name: 'life',
    outputs: [{internalType: 'contract LifeToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accLifePerShare', type: 'uint256'},
  ...
  {
    inputs: [{internalType: 'uint256', name: '_lifePerBlock', type: 'uint256'}],
    name: 'updateEmissionRate',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
...
async function main() {
  ...
  const VLAD_CHEF_ADDR = '0x67905ff1Ada0C11720E7298840206E5bdB8d3646'
  const rewardTokenTicker = 'LIFE'
  const VLAD_CHEF = new ethers.Contract(VLAD_CHEF_ADDR, VLAD_CHEF_ABI, App.provider)

  const rewardsPerWeek = (((await VLAD_CHEF.lifePerBlock()) / 1e18) * 604800) / 3

...
const BEEFY_STRATEGY_ABI = [
  ...
  {inputs: [], name: 'renounceOwnership', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {inputs: [], name: 'retireStrat', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {
    inputs: [],
    name: 'rewardPool',
    outputs: [{internalType: 'address', name: '', type: 'address'}],
...
async function printBeefyContract(poolInfo) {
  ...
  _print(
    `You are staking ${poolInfo.userStaked.toFixed(4)} ${poolPrices.name} ($${formatMoney(
      userStakedUsd

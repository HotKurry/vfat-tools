...
const LAMA_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract LlamaToken', name: '_lama', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
      {internalType: 'address', name: '_feeAddress', type: 'address'},
      {internalType: 'uint256', name: '_lamaPerBlock', type: 'uint256'},
    ],
  ...
  },
  {
    inputs: [],
    name: 'lama',
    outputs: [{internalType: 'contract LlamaToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accLamaPerShare', type: 'uint256'},
  ...
  {
    inputs: [{internalType: 'uint256', name: '_lamaPerBlock', type: 'uint256'}],
    name: 'updateLamaPerBlock',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
...
async function main() {
  ...
  const rewardsPerWeek = (((await LAMA_CHEF.lamaPerBlock()) / 1e18) * 604800) / 3

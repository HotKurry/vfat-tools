...
const SALT_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract SaltToken', name: '_salt', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
      {internalType: 'address', name: '_feeAddress', type: 'address'},
      {internalType: 'uint256', name: '_saltPerBlock', type: 'uint256'},
    ],
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accSaltPerShare', type: 'uint256'},
  ...
  {inputs: [], name: 'renounceOwnership', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {
    inputs: [],
    name: 'salt',
    outputs: [{internalType: 'contract SaltToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  {
    inputs: [{internalType: 'uint256', name: '_saltPerBlock', type: 'uint256'}],
...
async function main() {
  ...
  const SALT_CHEF_ADDR = '0xB4405445fFAcF2B86BC2bD7D1C874AC739265658'
  const rewardTokenTicker = 'SALT'
  const SALT_CHEF = new ethers.Contract(SALT_CHEF_ADDR, SALT_CHEF_ABI, App.provider)

  const rewardsPerWeek = (((await SALT_CHEF.saltPerBlock()) / 1e18) * 604800) / 3

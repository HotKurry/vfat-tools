...
const CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract ComosToken', name: '_comos', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
      {internalType: 'address', name: '_feeAddress', type: 'address'},
      {internalType: 'uint256', name: '_comosPerBlock', type: 'uint256'},
  ...
  },
  {
    inputs: [],
    name: 'comos',
    outputs: [{internalType: 'contract ComosToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  {
    inputs: [{internalType: 'uint256', name: '_comosPerBlock', type: 'uint256'}],
...
async function main() {
  ...
  const rewardsPerWeek = (((await CHEF.comosPerBlock()) / 1e18) * 604800) / 3

...
const PIN_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract PineappleToken', name: '_pin', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
      {internalType: 'address', name: '_feeAddress', type: 'address'},
      {internalType: 'uint256', name: '_pinPerBlock', type: 'uint256'},
  ...
  },
  {
    inputs: [],
    name: 'pin',
    outputs: [{internalType: 'contract PineappleToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accPinPerShare', type: 'uint256'},
  ...
  {
    inputs: [{internalType: 'uint256', name: '_pinPerBlock', type: 'uint256'}],
...
async function main() {
  ...
  const PIN_CHEF_ADDR = '0x3604556B1e275f53Fd30cFD836f734538f7C29B5'
  const rewardTokenTicker = 'PIN'
  const PIN_CHEF = new ethers.Contract(PIN_CHEF_ADDR, PIN_CHEF_ABI, App.provider)

  const rewardsPerWeek = (((await PIN_CHEF.pinPerBlock()) / 1e18) * 604800) / 3

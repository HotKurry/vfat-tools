...
const JIGG_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract JIGGToken', name: '_jigg', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
      {internalType: 'address', name: '_feeAddress', type: 'address'},
      {internalType: 'uint256', name: '_jiggPerBlock', type: 'uint256'},
  ...
  },
  {
    inputs: [],
    name: 'jigg',
    outputs: [{internalType: 'contract JIGGToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accJIGGPerShare', type: 'uint256'},
  ...
  {
    inputs: [{internalType: 'uint256', name: '_jiggPerBlock', type: 'uint256'}],
    name: 'updateEmissionRate',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
...
async function main() {
  ...
  const JIGG_CHEF_ADDR = '0x09f477426Be242a26d3f80596028e246d1B677D8'
  const rewardTokenTicker = 'JIGG'
  const JIGG_CHEF = new ethers.Contract(JIGG_CHEF_ADDR, JIGG_CHEF_ABI, App.provider)

  const rewardsPerWeek = (((await JIGG_CHEF.jiggPerBlock()) / 1e18) * 604800) / 3

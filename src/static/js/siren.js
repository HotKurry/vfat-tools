...
const AMM_ABI = [
  {
    anonymous: false,
    inputs: [
      {indexed: false, internalType: 'contract ISimpleToken', name: 'lpToken', type: 'address'},
  ...
  },
  {
    ...
    inputs: [
      ...
      {indexed: false, internalType: 'uint256', name: 'bTokensBought', type: 'uint256'},
      {indexed: false, internalType: 'uint256', name: 'collateralPaid', type: 'uint256'},
    ],
    name: 'BTokensBought',
    type: 'event',
  },
  {
    ...
    inputs: [
      ...
      {indexed: false, internalType: 'uint256', name: 'bTokensSold', type: 'uint256'},
      {indexed: false, internalType: 'uint256', name: 'collateralPaid', type: 'uint256'},
    ],
    name: 'BTokensSold',
    type: 'event',
  ...
  },
  {
    anonymous: false,
    inputs: [
      {indexed: false, internalType: 'address', name: 'lpAddress', type: 'address'},
      {indexed: false, internalType: 'bool', name: 'allowed', type: 'bool'},
    ],
    name: 'DepositAllowedUpdated',
    type: 'event',
  },
  {
    anonymous: false,
    inputs: [
      {indexed: false, internalType: 'bool', name: 'isEnforced', type: 'bool'},
      {indexed: false, internalType: 'uint256', name: 'globalLimit', type: 'uint256'},
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      {indexed: false, internalType: 'uint256', name: 'collateralRemoved', type: 'uint256'},
      {indexed: false, internalType: 'uint256', name: 'paymentRemoved', type: 'uint256'},
  ...
  },
  {
    ...
    inputs: [
      ...
      {indexed: false, internalType: 'uint256', name: 'collateralAdded', type: 'uint256'},
  ...
  {
    anonymous: false,
    inputs: [{indexed: false, internalType: 'uint256', name: 'newVolatilityFactor', type: 'uint256'}],
  ...
  },
  {
    ...
    inputs: [
      {indexed: false, internalType: 'address', name: 'buyer', type: 'address'},
      {indexed: false, internalType: 'uint256', name: 'wTokensBought', type: 'uint256'},
      {indexed: false, internalType: 'uint256', name: 'collateralPaid', type: 'uint256'},
    ],
    name: 'WTokensBought',
    type: 'event',
  },
  {
    ...
    inputs: [
      {indexed: false, internalType: 'address', name: 'seller', type: 'address'},
      {indexed: false, internalType: 'uint256', name: 'wTokensSold', type: 'uint256'},
      {indexed: false, internalType: 'uint256', name: 'collateralPaid', type: 'uint256'},
    ],
    name: 'WTokensSold',
    type: 'event',
  ...
  },
  {
    inputs: [
      ...
      {internalType: 'uint256', name: 'bTokenAmount', type: 'uint256'},
      {internalType: 'uint256', name: 'collateralMaximum', type: 'uint256'},
    ],
    name: 'bTokenBuy',
    outputs: [{internalType: 'uint256', name: '', type: 'uint256'}],
  ...
  },
  {
    inputs: [
      {internalType: 'uint256', name: 'marketIndex', type: 'uint256'},
      {internalType: 'uint256', name: 'bTokenAmount', type: 'uint256'},
      {internalType: 'uint256', name: 'collateralMinimum', type: 'uint256'},
    ],
    name: 'bTokenSell',
    outputs: [{internalType: 'uint256', name: '', type: 'uint256'}],
    stateMutability: 'nonpayable',
  ...
  {inputs: [], name: 'claimAllExpiredTokens', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {
    inputs: [
      {internalType: 'contract IMarket', name: 'optionMarket', type: 'address'},
      {internalType: 'uint256', name: 'wTokenBalance', type: 'uint256'},
    ],
  ...
  },
  {
    ...
    name: 'collateralDepositLimits',
    outputs: [
      {internalType: 'bool', name: 'allowedToDeposit', type: 'bool'},
  ...
  },
  {
    ...
    outputs: [{internalType: 'address', name: 'logicAddress', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
    ...
    name: 'getMarket',
    outputs: [{internalType: 'contract IMarket', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    name: 'getTokensSaleValue',
    outputs: [{internalType: 'uint256', name: '', type: 'uint256'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
    inputs: [{internalType: 'bool', name: 'includeUnclaimed', type: 'bool'}],
  ...
  {
    inputs: [
      {internalType: 'contract IMarketsRegistry', name: '_registry', type: 'address'},
      {internalType: 'contract AggregatorV3Interface', name: '_priceOracle', type: 'address'},
      ...
      {internalType: 'address', name: '_tokenImplementation', type: 'address'},
      {internalType: 'uint16', name: '_tradeFeeBasisPoints', type: 'uint16'},
      {internalType: 'bool', name: '_shouldInvertOraclePrice', type: 'bool'},
    ],
    name: 'initialize',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    inputs: [],
    name: 'lpToken',
    outputs: [{internalType: 'contract ISimpleToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    inputs: [
      ...
      {internalType: 'uint256', name: 'lpTokenMinimum', type: 'uint256'},
    ],
    name: 'provideCapital',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    inputs: [],
    name: 'registry',
    outputs: [{internalType: 'contract IMarketsRegistry', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    inputs: [
      {internalType: 'bool', name: '_enforceDepositLimits', type: 'bool'},
      {internalType: 'uint256', name: '_globalDepositLimit', type: 'uint256'},
    ],
    name: 'setEnforceDepositLimits',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
    inputs: [{internalType: 'uint256', name: '_volatilityFactor', type: 'uint256'}],
  ...
  {
    inputs: [{internalType: 'address', name: 'newAmmImplementation', type: 'address'}],
  ...
  },
  {
    inputs: [
      ...
      {internalType: 'bool', name: 'sellTokens', type: 'bool'},
      {internalType: 'uint256', name: 'collateralMinimum', type: 'uint256'},
    ],
...
async function main() {
  ...
  const dp = await loadSynthetixPoolInfo(
    App,
    tokens,
    prices,
    SI_STAKING_ABI,
    '0x30293259e3c0034b38e46d464cf5b0ee652d1d07',
    'rewardsToken',
    'stakingToken'
  )

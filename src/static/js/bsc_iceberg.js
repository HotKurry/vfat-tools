...
const TIT_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract TitanicToken', name: '_tit', type: 'address'},
  ...
  {
    inputs: [],
    name: 'icebergReferral',
    outputs: [{internalType: 'contract IIcebergReferral', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accTitPerShare', type: 'uint256'},
  ...
  {
    inputs: [{internalType: 'contract IIcebergReferral', name: '_icebergReferral', type: 'address'}],
    name: 'setIcebergReferral',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  ...
  },
  {
    inputs: [],
    name: 'tit',
    outputs: [{internalType: 'contract TitanicToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
...
async function main() {
  ...
  const TIT_CHEF_ADDR = '0xC5cCa5436bC8BB734e24d6d12f1Cfd88D8Faa370'
  const rewardTokenTicker = 'TIT'
  const TIT_CHEF = new ethers.Contract(TIT_CHEF_ADDR, TIT_CHEF_ABI, App.provider)

  const rewardsPerWeek = (((await TIT_CHEF.titPerBlock()) / 1e18) * 604800) / 3

...
const GOAT_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract GoatToken', name: '_goat', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
      {internalType: 'address', name: '_feeAddress', type: 'address'},
      {internalType: 'uint256', name: '_goatPerBlock', type: 'uint256'},
  ...
  },
  {
    inputs: [],
    name: 'goat',
    outputs: [{internalType: 'contract GoatToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accGOATPerShare', type: 'uint256'},
  ...
  {
    inputs: [{internalType: 'uint256', name: '_goatPerBlock', type: 'uint256'}],
...
async function main() {
  ...
  const GOAT_CHEF_ADDR = '0xc7d1de2a71d7765da11387ed8629a247bd4b61c9'
  const rewardTokenTicker = 'GOAT'
  const GOAT_CHEF = new ethers.Contract(GOAT_CHEF_ADDR, GOAT_CHEF_ABI, App.provider)

  const rewardsPerWeek = (((await GOAT_CHEF.goatPerBlock()) / 1e18) * 604800) / 3

...
const BINGO_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'address', name: '_share', type: 'address'},
      {internalType: 'address', name: '_daoFundAddr', type: 'address'},
    ],
  ...
  {
    inputs: [{internalType: 'address', name: '_daoFundAddr', type: 'address'}],
    name: 'setDAOFundAddr',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
...
async function main() {
  ...
  const rewardsPerWeek = (((await BINGO_CHEF.sharePerBlock()) / 1e18) * 604800) / 3

...
const MASH_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract MashToken', name: '_mash', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
      {internalType: 'address', name: '_feeAddress', type: 'address'},
      {internalType: 'uint256', name: '_mashPerBlock', type: 'uint256'},
  ...
  },
  {
    inputs: [],
    name: 'mash',
    outputs: [{internalType: 'contract MashToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  {
    inputs: [{internalType: 'uint256', name: '_mashPerBlock', type: 'uint256'}],
...
async function main() {
  ...
  const MASH_CHEF_ADDR = '0x8932a6265b01D1D4e1650fEB8Ac38f9D79D3957b'
  const rewardTokenTicker = 'MASH'
  const MASH_CHEF = new ethers.Contract(MASH_CHEF_ADDR, MASH_CHEF_ABI, App.provider)

  const rewardsPerWeek = (((await MASH_CHEF.mashPerBlock()) / 1e18) * 604800) / 3

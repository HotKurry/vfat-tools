...
const BOURBON_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract BrrlToken', name: '_brrl', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
      {internalType: 'address', name: '_feeAddress', type: 'address'},
      {internalType: 'uint256', name: '_brrlPerBlock', type: 'uint256'},
    ],
  ...
  },
  {
    inputs: [],
    name: 'brrl',
    outputs: [{internalType: 'contract BrrlToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accBrrlPerShare', type: 'uint256'},
  ...
  {
    inputs: [{internalType: 'uint256', name: '_brrlPerBlock', type: 'uint256'}],
    name: 'updateBrrlPerBlock',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
...
async function main() {
  ...
  const BOURBON_CHEF_ADDR = '0xa893176a721587daed3575bb25906fa06dd26817'
  const rewardTokenTicker = 'BRRL'
  const BOURBON_CHEF = new ethers.Contract(BOURBON_CHEF_ADDR, BOURBON_CHEF_ABI, App.provider)

  const rewardsPerWeek = (((await BOURBON_CHEF.brrlPerBlock()) / 1e18) * 604800) / 3

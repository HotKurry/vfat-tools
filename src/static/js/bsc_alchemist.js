...
const MIST_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract MistToken', name: '_mist', type: 'address'},
  ...
  {inputs: [], name: 'massUpdatePools', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {
    inputs: [],
    name: 'mist',
    outputs: [{internalType: 'contract MistToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    inputs: [],
    name: 'mistReferral',
    outputs: [{internalType: 'contract IMistReferral', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accMistPerShare', type: 'uint256'},
  ...
  {
    inputs: [{internalType: 'contract IMistReferral', name: '_mistReferral', type: 'address'}],
    name: 'setMistReferral',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
...
const AURUM_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract AurumToken', name: '_aurum', type: 'address'},
      {internalType: 'uint256', name: '_startBlock', type: 'uint256'},
    ],
    stateMutability: 'nonpayable',
    type: 'constructor',
  ...
  },
  {
    inputs: [],
    name: 'aurum',
    outputs: [{internalType: 'contract AurumToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    inputs: [],
    name: 'aurumReferral',
    outputs: [{internalType: 'contract IAurumReferral', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'allocPoint', type: 'uint256'},
      {internalType: 'uint256', name: 'lastRewardBlock', type: 'uint256'},
      {internalType: 'uint256', name: 'accAurumPerShare', type: 'uint256'},
      {internalType: 'uint16', name: 'depositFeeBP', type: 'uint16'},
    ],
    stateMutability: 'view',
    type: 'function',
  ...
  {
    inputs: [{internalType: 'contract IAurumReferral', name: '_aurumReferral', type: 'address'}],
    name: 'setAurumReferral',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
...
async function main() {
  ...
  const MIST_CHEF_ADDR = '0x43404359bB38F5135aB8e25c62902015a49A0074'
  const AURUM_CHEF_ADDR = '0x193765551a49eAD3aA8C693F19C4501710cD874d'
  const rewardTokenTicker0 = 'MIST'
  const rewardTokenTicker1 = 'AURUM'
  const MIST_CHEF = new ethers.Contract(MIST_CHEF_ADDR, MIST_CHEF_ABI, App.provider)
  const AURUM_CHEF = new ethers.Contract(AURUM_CHEF_ADDR, AURUM_CHEF_ABI, App.provider)

  const rewardsPerWeek0 = (((await MIST_CHEF.mistPerBlock()) / 1e18) * 604800) / 3
  const rewardsPerWeek1 = (((await AURUM_CHEF.aurumPerBlock()) / 1e18) * 604800) / 3

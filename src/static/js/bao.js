...
async function main() {
  ...
  const BAO_CHEF_ABI = [
    {
      inputs: [
        {internalType: 'contract BaoToken', name: '_Bao', type: 'address'},
        {internalType: 'address', name: '_devaddr', type: 'address'},
        {internalType: 'address', name: '_liquidityaddr', type: 'address'},
        {internalType: 'address', name: '_comfundaddr', type: 'address'},
        {internalType: 'address', name: '_founderaddr', type: 'address'},
        ...
        {internalType: 'uint256', name: '_userDepFee', type: 'uint256'},
        {internalType: 'uint256', name: '_devDepFee', type: 'uint256'},
        {internalType: 'uint256[]', name: '_blockDeltaStartStage', type: 'uint256[]'},
        {internalType: 'uint256[]', name: '_blockDeltaEndStage', type: 'uint256[]'},
        {internalType: 'uint256[]', name: '_userFeeStage', type: 'uint256[]'},
    ...
    },
    {
      inputs: [],
      name: 'Bao',
      outputs: [{internalType: 'contract BaoToken', name: '', type: 'address'}],
    ...
    },
    {
      ...
      outputs: [
        ...
        {internalType: 'uint256', name: 'forCom', type: 'uint256'},
    ...
    },
    {
      inputs: [],
      name: 'migrator',
      outputs: [{internalType: 'contract IMigratorToBaoSwap', name: '', type: 'address'}],
      stateMutability: 'view',
      type: 'function',
    },
    {
    ...
    },
    {
      ...
      outputs: [
        ...
        {internalType: 'uint256', name: 'accBaoPerShare', type: 'uint256'},
      ],
      stateMutability: 'view',
      type: 'function',
    },
    ...
    {
      inputs: [{internalType: 'contract IMigratorToBaoSwap', name: '_migrator', type: 'address'}],
      name: 'setMigrator',
      outputs: [],
      stateMutability: 'nonpayable',
      type: 'function',
    ...
    },
    {
      ...
      name: 'userGlobalInfo',
      outputs: [
        {internalType: 'uint256', name: 'globalAmount', type: 'uint256'},
        {internalType: 'uint256', name: 'totalReferals', type: 'uint256'},
    ...
    },
    {
      ...
      outputs: [
        ...
        {internalType: 'uint256', name: 'blockdelta', type: 'uint256'},
...
async function loadChefBaoContract(
  App,
  chef,
  chefAddress,
  chefAbi,
  ...
  const poolInfos = await Promise.all(
    [...Array(poolCount).keys()].map(
      async x => await getBaoPoolInfo(App, chefContract, chefAddress, x, pendingRewardsFunction)
    )
  )
...
async function getBaoPoolInfo(app, chefContract, chefAddress, poolIndex, pendingRewardsFunction) {
  ...
  if (
    poolToken.token0 == '0x0Ba45A8b5d5575935B8158a88C631E9F9C95a2e5' ||
    poolToken.token1 == '0x0Ba45A8b5d5575935B8158a88C631E9F9C95a2e5'
  ) {
    return null
  }

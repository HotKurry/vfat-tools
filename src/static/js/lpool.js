...
async function main() {
  ...
  const LAUNCHPOOL_STAKING_ABI0 = [
    {
      inputs: [
        ...
        {internalType: 'uint256', name: '_maxRewardTokenAvailableForFarming', type: 'uint256'},
    ...
    {
      inputs: [],
      name: 'maxRewardTokenAvailableForFarming',
      outputs: [{internalType: 'uint256', name: '', type: 'uint256'}],
      stateMutability: 'view',
      type: 'function',
    },
    ...
    {
      inputs: [],
      name: 'rewardGuildBank',
      outputs: [{internalType: 'contract Guild', name: '', type: 'address'}],
      stateMutability: 'view',
      type: 'function',
    },
    {
  ...
  let p0 = await loadLaunchpoolChefContract(
    App,
    LAUNCHPOOL_CONTRACT3,
    LAUNCHPOOL_CHEF_ADDR3,
    LAUNCHPOOL_STAKING_ABI0,
    launchpoolRewardTokenTicker,
    tokenRewardAddress,
    null,
    rewardsPerWeek3,
    'pendingRewards'
  ...
  let p1 = await loadLaunchpoolChefContract(
    App,
    LAUNCHPOOL_CONTRACT0,
    LAUNCHPOOL_CHEF_ADDR0,
    LAUNCHPOOL_STAKING_ABI0,
    launchpoolRewardTokenTicker,
    tokenRewardAddress,
    null,
  ...
  let p2 = await loadLaunchpoolChefContract(
    App,
    LAUNCHPOOL_CONTRACT1,
    LAUNCHPOOL_CHEF_ADDR1,
    LAUNCHPOOL_STAKING_ABI0,
    launchpoolRewardTokenTicker,
    tokenRewardAddress,
    null,
  ...
  let p3 = await loadLaunchpoolChefContract(
    App,
    LAUNCHPOOL_CONTRACT2,
    LAUNCHPOOL_CHEF_ADDR2,
    LAUNCHPOOL_STAKING_ABI1,
    launchpoolRewardTokenTicker,
    tokenRewardAddress,
    null,
    rewardsPerWeek2,
...
async function loadLaunchpoolChefContract(
  App,
  chef,
  chefAddress,
  chefAbi,

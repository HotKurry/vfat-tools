...
const EPS_CHEF_ABI = [
  {
    inputs: [
      ...
      {internalType: 'contract IERC20', name: '_fixedRewardToken', type: 'address'},
    ],
  ...
  {
    inputs: [{internalType: 'contract Oracle', name: '_oracle', type: 'address'}],
    name: 'addOracle',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {inputs: [], name: 'renounceOwnership', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {
    inputs: [],
    name: 'rewardMinter',
    outputs: [{internalType: 'contract Minter', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  {
    inputs: [{internalType: 'contract Minter', name: '_rewardMinter', type: 'address'}],
    name: 'setMinter',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
...
async function loadBscEllipsisContract(
  App,
  tokens,
  prices,
  chef,
  ...
  const poolInfos = await Promise.all(
    [...Array(poolCount).keys()].map(
      async x => await getBscEllipsisPoolInfo(App, chefContract, chefAddress, x, pendingRewardsFunction)
    )
  )

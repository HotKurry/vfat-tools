...
async function main() {
  ...
  const rewardsPerWeekLpStake2 = (((await WAULT_LP_STAKE_CONTRACT2.waultPerBlock()) / 1e18) * 604800) / 3
  ...
  await loadBscWaultLpStakeContract(
    ...
    tokens,
    prices,
    WAULT_LP_STAKE_CONTRACT2,
    WAULT_ADDR_LP_STAKE2,
    WAULT_LP_STAKE_ABI,
    rewardTokenTicker,
    'wault',
    null,
    rewardsPerWeekLpStake2,
    'pendingRewards'
  )

...
const ZEX_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract ZexSwap', name: '_zex', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
      {internalType: 'address', name: '_feeAddress', type: 'address'},
      {internalType: 'uint256', name: '_zexPerBlock', type: 'uint256'},
  ...
  },
  {
    inputs: [],
    name: 'Zex',
    outputs: [{internalType: 'contract ZexSwap', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accZexPerShare', type: 'uint256'},
  ...
  {
    inputs: [{internalType: 'uint256', name: '_zexPerBlock', type: 'uint256'}],
...
async function main() {
  ...
  const ZEX_CHEF_ADDR = '0x9D81cc945D132230844dCACFD9c20A67A5b6dd9D'
  const rewardTokenTicker = 'ZEX'
  const ZEX_CHEF = new ethers.Contract(ZEX_CHEF_ADDR, ZEX_CHEF_ABI, App.provider)

  const rewardsPerWeek = (((await ZEX_CHEF.ZexPerBlock()) / 1e18) * 604800) / 3

...
const BSG_ORACLE_ABI = [
  {
    inputs: [
      ...
      {internalType: 'contract ILinkOracle', name: '_linkOracle', type: 'address'},
    ],
  ...
  },
  {
    anonymous: false,
    inputs: [
      {indexed: false, internalType: 'uint256', name: 'price0CumulativeLast', type: 'uint256'},
      {indexed: false, internalType: 'uint256', name: 'price1CumulativeLast', type: 'uint256'},
    ],
    name: 'Updated',
    type: 'event',
  },
  ...
  },
  {
    inputs: [],
    name: 'linkOracle',
    outputs: [{internalType: 'contract ILinkOracle', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    name: 'pairFor',
    outputs: [{internalType: 'address', name: 'lpt', type: 'address'}],
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'price0Average', type: 'uint256'},
      {internalType: 'uint256', name: 'price1Average', type: 'uint256'},
    ],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    inputs: [{internalType: 'address', name: 'newOperator_', type: 'address'}],

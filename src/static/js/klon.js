...
const KLON_POOLS_STAKING_ABI = [
  ...
  },
  {
    ...
    inputs: [
      ...
      {indexed: false, internalType: 'address', name: 'newBoardroom', type: 'address'},
    ],
    name: 'BoardroomChanged',
    type: 'event',
  },
  {
    anonymous: false,
  ...
  },
  {
    ...
    inputs: [],
    name: 'boardroom',
    outputs: [{internalType: 'contract IBoardroom', name: '', type: 'address'}],
    payable: false,
    stateMutability: 'view',
    type: 'function',
  },
  ...
  {
    constant: false,
    inputs: [{internalType: 'address', name: '_boardroom', type: 'address'}],
    name: 'setBoardroom',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',

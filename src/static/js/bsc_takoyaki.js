...
const TAKOYAKI_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract TakoyakiToken', name: '_takoyaki', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
      {internalType: 'address', name: '_feeAddress', type: 'address'},
      {internalType: 'uint256', name: '_takoyakiPerBlock', type: 'uint256'},
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accTakoyakiPerShare', type: 'uint256'},
  ...
  },
  {
    inputs: [],
    name: 'takoyaki',
    outputs: [{internalType: 'contract TakoyakiToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  {
    inputs: [{internalType: 'uint256', name: '_takoyakiPerBlock', type: 'uint256'}],
    name: 'updateEmissionRate',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
...
async function main() {
  ...
  const TAKOYAKI_CHEF_ADDR = '0x69228253d69e14e9f6d994b8f73590c24d3d26e2'
  const rewardTokenTicker = 'TAKO'
  const TAKOYAKI_CHEF = new ethers.Contract(TAKOYAKI_CHEF_ADDR, TAKOYAKI_CHEF_ABI, App.provider)

  const rewardsPerWeek = (((await TAKOYAKI_CHEF.takoyakiPerBlock()) / 1e18) * 604800) / 3

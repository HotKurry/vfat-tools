...
const Pools = ['0x81c071E795CE29EB155c9818f06786640d0AdB2b', '0xF9aE19cf447B3560aFc407D9AAC9e2007d4efe43'].map(a => {
  return {
    address: a,
...
async function main() {
  ...
  _print(
    `Estimated earnings: Day $${formatMoney(dailyUBI)}, Week $${formatMoney(dailyUBI * 7)}, Year $${formatMoney(
      dailyUBI * 365
    )}`
  )
  hideLoading()

...
const BBOO_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract BambooToken', name: '_cake', type: 'address'},
      {internalType: 'contract LeafBar', name: '_syrup', type: 'address'},
  ...
  },
  {
    inputs: [],
    name: 'cake',
    outputs: [{internalType: 'contract BambooToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    inputs: [],
    name: 'syrup',
    outputs: [{internalType: 'contract LeafBar', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
...
async function main() {
  ...
  const BBOO_CHEF_ADDR = '0x51f015e3dEA234039fB536C358781118f36f1745'
  const rewardTokenTicker = 'BBOO'
  const BBOO_CHEF = new ethers.Contract(BBOO_CHEF_ADDR, BBOO_CHEF_ABI, App.provider)

  const rewardsPerWeek = (((await BBOO_CHEF.cakePerBlock()) / 1e18) * 604800) / 3

...
const MOCHI_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract MochiToken', name: '_mochi', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
      {internalType: 'uint256', name: '_mochiPerBlock', type: 'uint256'},
  ...
  },
  {
    inputs: [],
    name: 'mochi',
    outputs: [{internalType: 'contract MochiToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accMochiPerShare', type: 'uint256'},
    ],
    stateMutability: 'view',
    type: 'function',
  },
...
async function main() {
  ...
  const rewardsPerWeek = (((await MOCHI_CHEF.mochiPerBlock()) / 1e18) * 604800) / 3

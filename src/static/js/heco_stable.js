...
const STABLE_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'address', name: 'hss_', type: 'address'},
...
const StableAddresses = ['0xdD4Ad8D345E02eb5ACE50f0a5dBE36871Aec7ef9', '0x091c9fA098Bd1fe978EE49E3A11773a8970268AB']
...
async function main() {
  ...
  await loadHecoSynthetixPoolInfo(
    App,
    tokens,
    prices,
    StablePools[0].abi,
    StablePools[0].address,
    StablePools[0].rewardTokenFunction,
    StablePools[0].stakeTokenFunction
  )

...
const CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract RoyalToken', name: '_royal', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
      {internalType: 'address', name: '_feeAddress', type: 'address'},
      {internalType: 'uint256', name: '_royalPerBlock', type: 'uint256'},
  ...
  {inputs: [], name: 'renounceOwnership', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {
    inputs: [],
    name: 'royal',
    outputs: [{internalType: 'contract RoyalToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  {
    inputs: [{internalType: 'uint256', name: '_royalPerBlock', type: 'uint256'}],
...
async function main() {
  ...
  const CHEF_ADDR = '0x7456fc08613d5aaca788a85888f3cc116ef736e6'
  const rewardTokenTicker = 'ROYA'
  const CHEF = new ethers.Contract(CHEF_ADDR, CHEF_ABI, App.provider)

  const rewardsPerWeek = (((await CHEF.royalPerBlock()) / 1e18) * 604800) / 3

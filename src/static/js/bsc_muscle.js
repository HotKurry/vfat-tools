...
const MUSCLE_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract MuscleToken', name: '_muscle', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
      {internalType: 'address', name: '_feeAddress', type: 'address'},
      {internalType: 'uint256', name: '_musclePerBlock', type: 'uint256'},
  ...
  {inputs: [], name: 'massUpdatePools', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {
    inputs: [],
    name: 'muscle',
    outputs: [{internalType: 'contract MuscleToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accMusclePerShare', type: 'uint256'},
  ...
  {
    inputs: [{internalType: 'uint256', name: '_musclePerBlock', type: 'uint256'}],
...
async function main() {
  ...
  const MUSCLE_CHEF_ADDR = '0x61119DAD9D39d29212927bA21943122fe5BA7fc2'
  const rewardTokenTicker = 'MUSCLE'
  const MUSCLE_CHEF = new ethers.Contract(MUSCLE_CHEF_ADDR, MUSCLE_CHEF_ABI, App.provider)
  ...
  if (startBlock > currentBlock) {
    ...
    rewardsPerWeek = (((await MUSCLE_CHEF.musclePerBlock()) / 1e18) * 604800) / 3

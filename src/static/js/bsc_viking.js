...
const VIKING_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract VikingToken', name: '_viking', type: 'address'},
  ...
  },
  {
    inputs: [],
    name: 'viking',
    outputs: [{internalType: 'contract VikingToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
...
async function main() {
  ...
  const rewardsPerWeek = (((await VIKING_CHEF.vikingPerBlock()) / 1e18) * 604800) / 3

...
async function loadMeerkatContract(
  App,
  tokens,
  prices,
  chef,
  ...
  const poolInfos = await Promise.all(
    [...Array(poolCount).keys()].map(
      async x => await getMeerkatPoolInfo(App, chefContract, chefAddress, x, pendingRewardsFunction)
    )
  )

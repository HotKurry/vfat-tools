...
const RA_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract CustomToken', name: '_viking', type: 'address'},
  ...
  },
  {
    inputs: [],
    name: 'viking',
    outputs: [{internalType: 'contract CustomToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
...
async function main() {
  ...
  const rewardsPerWeek = (((await RA_CHEF.vikingPerBlock()) / 1e18) * 604800) / 3

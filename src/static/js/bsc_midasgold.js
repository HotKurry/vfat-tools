...
const MIDASGOLD_CHEF_ABI = [
  ...
  {
    inputs: [
      {internalType: 'address', name: '_mdg', type: 'address'},
      {internalType: 'address', name: '_mdo', type: 'address'},
      {internalType: 'address', name: '_bcash', type: 'address'},
      {internalType: 'uint256', name: '_rewardPerBlock', type: 'uint256'},
      {internalType: 'uint256', name: '_startBlock', type: 'uint256'},
      {internalType: 'uint256', name: '_lockUntilBlock', type: 'uint256'},
      {internalType: 'address', name: '_mdgLocker', type: 'address'},
      {internalType: 'address', name: '_reserveFund', type: 'address'},
  ...
  },
  {
    inputs: [],
    name: 'migrator',
    outputs: [{internalType: 'contract ILiquidityMigrator', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accMdgPerShare', type: 'uint256'},
      {internalType: 'uint256', name: 'accMdoPerShare', type: 'uint256'},
      {internalType: 'uint256', name: 'accBcashPerShare', type: 'uint256'},
  ...
  {
    inputs: [{internalType: 'uint256', name: '_bcashPerBlock', type: 'uint256'}],
    name: 'setBcashPerBlock',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
    inputs: [{internalType: 'uint256', name: '_mdoPerBlock', type: 'uint256'}],
    name: 'setMdoPerBlock',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [{internalType: 'contract ILiquidityMigrator', name: '_migrator', type: 'address'}],
    name: 'setMigrator',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [{internalType: 'address', name: '_reserveFund', type: 'address'}],
    name: 'setReserveFund',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'mdoDebt', type: 'uint256'},
      {internalType: 'uint256', name: 'bcashDebt', type: 'uint256'},
    ],
    stateMutability: 'view',
    type: 'function',
  },
...
const MDG2_CHEF_ABI = [
  ...
  {inputs: [], name: 'harvestAllRewards', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {inputs: [], name: 'harvestAndRestake', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {
    inputs: [
      {internalType: 'uint256', name: '_layerId', type: 'uint256'},
      {internalType: 'address', name: '_mdg', type: 'address'},
      {internalType: 'uint256', name: '_rewardPerBlock', type: 'uint256'},
      {internalType: 'uint256', name: '_startBlock', type: 'uint256'},
      {internalType: 'uint256', name: '_lockUntilBlock', type: 'uint256'},
      {internalType: 'address', name: '_layeredMdgLocker', type: 'address'},
      {internalType: 'address', name: '_reserveFund', type: 'address'},
      {internalType: 'address', name: '_operator', type: 'address'},
    ],
    name: 'initialize',
  ...
  {
    inputs: [{internalType: 'bool', name: '_halvingChecked', type: 'bool'}],
  ...
  {
    inputs: [{internalType: 'uint256', name: '_mdgPoolId', type: 'uint256'}],
    name: 'setMdgPoolId',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [
      {internalType: 'uint256', name: '_reservePercent', type: 'uint256'},
      {internalType: 'uint256', name: '_lockPercent', type: 'uint256'},
      {internalType: 'uint256', name: '_rewardHalvingRate', type: 'uint256'},
    ],
    name: 'setRates',
    outputs: [],
    stateMutability: 'nonpayable',
...
const MDG3_CHEF_ABI = [
  ...
  },
  {
    ...
    outputs: [
      {internalType: 'contract IERC20', name: 'lpToken', type: 'address'},
      {internalType: 'address', name: 'reward2', type: 'address'},
      {internalType: 'uint256', name: 'allocPoint', type: 'uint256'},
      {internalType: 'uint256', name: 'lastRewardBlock', type: 'uint256'},
      {internalType: 'uint256', name: 'accMdgPerShare', type: 'uint256'},
      {internalType: 'uint256', name: 'accLockPerShare', type: 'uint256'},
      {internalType: 'uint256', name: 'accReward2PerShare', type: 'uint256'},
      {internalType: 'uint256', name: 'reward2PerBlock', type: 'uint256'},
      {internalType: 'uint256', name: 'reward2EndBlock', type: 'uint256'},
      {internalType: 'uint16', name: 'depositFeeBP', type: 'uint16'},
      {internalType: 'bool', name: 'isStarted', type: 'bool'},
    ],
    stateMutability: 'view',
  ...
  {
    inputs: [
      {internalType: 'uint256', name: '_halvingPeriod', type: 'uint256'},
      {internalType: 'uint256', name: '_nextHalvingBlock', type: 'uint256'},
    ],
  ...
  },
  {
    inputs: [
      {internalType: 'uint256', name: '_pid', type: 'uint256'},
      {internalType: 'address', name: '_reward2', type: 'address'},
      {internalType: 'uint256', name: '_reward2PerBlock', type: 'uint256'},
      {internalType: 'uint256', name: '_reward2EndBlock', type: 'uint256'},
    ],
    name: 'setReward2',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  },
  {
    inputs: [
      {internalType: 'uint256', name: '_startBlock', type: 'uint256'},
      {internalType: 'uint256', name: '_lockUntilBlock', type: 'uint256'},
      {internalType: 'uint256', name: '_bigHalvingBlock', type: 'uint256'},
  ...
  },
  {
    ...
    outputs: [
      {internalType: 'uint256', name: 'amount', type: 'uint256'},
      {internalType: 'uint256', name: 'rewardDebt', type: 'uint256'},
      {internalType: 'uint256', name: 'lockDebt', type: 'uint256'},
      {internalType: 'uint256', name: 'reward2Debt', type: 'uint256'},
    ],
    stateMutability: 'view',
    type: 'function',
  },
...
async function main() {
  ...
  await loadBscMidasgoldContract(
    App,
    tokens,
    prices,
    MIDASGOLD_CHEF,
    ...
    MIDASGOLD_CHEF_ABI,
    rewardTokenTickers,
    rewardTokenFunctions,
    rewardsPerWeek,
    pendingRewardFunctions
  )

  await loadMDG2ChefContract(
    App,
    tokens,
    prices,
    MDG2_CHEF,
  ...
  await loadMDG2ChefContract(
    ...
    MDG3_CHEF_ADDR,
    MDG3_CHEF_ABI,
    rewardTokenTickerMDG3,
    'mdg',
    null,
    rewardsPerWeekMDG3,
    pendingRewardFunction,
    [1]
  )
...
async function loadBscMidasgoldContract(
  App,
  tokens,
  prices,
  chef,
  ...
  let poolInfos = await Promise.all(
    [...Array(poolCount).keys()].map(
      async x => await getMidasGoldPoolInfo(App, chefContract, chefAddress, x, pendingRewardFunctions)
    )
  )
...
async function getMidasGoldPoolInfo(app, chefContract, chefAddress, poolIndex, pendingRewardFunctions) {
  ...
  let pendingRewardTokensArray = await Promise.all(
    pendingRewardFunctions.map(f => chefContract.callStatic[f](poolIndex, app.YOUR_ADDRESS))
  )
...
function printMidasGoldApr(
  ...
  _print(
    `You are staking ${userStaked.toFixed(2)} ${stakeTokenTicker} ($${formatMoney(
      userStakedUsd
  ...
  if (userStaked > 0) {
    for (let i = 0; i < rewardTokenTickers.length; i++) {
      ...
      _print(
        `Estimated ${rewardTokenTickers[i]} earnings:` +
...
function printMidasgoldContractLinks(
  App,
  chefAbi,
  chefAddr,
  poolIndex,
...
const midasgoldContract_claim = async function(chefAbi, chefAddress, poolIndex, App, pendingRewardsFunctions) {
  const signer = App.provider.getSigner()

  const CHEF_CONTRACT = new ethers.Contract(chefAddress, chefAbi, signer)

  let earnedTokenAmounts = await Promise.all(
    pendingRewardsFunctions.map(pf => CHEF_CONTRACT.callStatic[pf](poolIndex, app.YOUR_ADDRESS))
  )
...
async function loadMDG2ChefContract(
  App,
  tokens,
  prices,
  chef,

...
const STBB_CONTRACT_ABI = [
  {
    inputs: [
      {internalType: 'address', name: '_treasury', type: 'address'},
      {internalType: 'contract StabilizeBSCToken', name: '_stabilize', type: 'address'},
  ...
  },
  {
    anonymous: false,
    inputs: [
      {indexed: false, internalType: 'address', name: 'oldGov', type: 'address'},
      {indexed: false, internalType: 'address', name: 'newGov', type: 'address'},
    ],
  ...
  {anonymous: false, inputs: [], name: 'MintingEnded', type: 'event'},
  {
    anonymous: false,
    inputs: [
      {indexed: false, internalType: 'uint256', name: 'weekNum', type: 'uint256'},
  ...
  {inputs: [], name: 'finishAddActivePool', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {inputs: [], name: 'finishAddNewPool', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {inputs: [], name: 'finishChangeDeveloperTreasury', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {inputs: [], name: 'finishChangeMinStakeTime', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {inputs: [], name: 'finishChangeRebalanceFrequency', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {inputs: [], name: 'finishChangeRewardPercentLP', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {inputs: [], name: 'finishGovernanceChange', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {inputs: [], name: 'finishRemoveActivePool', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {
    inputs: [{internalType: 'uint256', name: '_pos', type: 'uint256'}],
    name: 'getActivePoolPID',
    outputs: [{internalType: 'uint256', name: '', type: 'uint256'}],
    stateMutability: 'view',
    type: 'function',
  },
  ...
  },
  {
    inputs: [
      ...
      {internalType: 'bool', name: '_blocked', type: 'bool'},
    ],
    name: 'governanceSetBlockedContracts',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
    ...
    name: 'governanceSetWeightOnPool',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  ...
  {
    inputs: [],
    name: 'minSTBBStakeTime',
    outputs: [{internalType: 'uint256', name: '', type: 'uint256'}],
    stateMutability: 'view',
    type: 'function',
  },
  {inputs: [], name: 'mintNewWeek', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {
    inputs: [],
    name: 'periodFinished',
    outputs: [{internalType: 'uint256', name: '', type: 'uint256'}],
  ...
  {inputs: [], name: 'rebalancePoolRewards', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {
    inputs: [
      {internalType: 'uint256', name: '_pid', type: 'uint256'},
  ...
  },
  {
    inputs: [
      {internalType: 'address', name: '_address', type: 'address'},
      {internalType: 'bool', name: '_lpPool', type: 'bool'},
    ],
    name: 'startAddNewPool',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
    ...
    name: 'startChangeDeveloperTreasury',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
    ...
    name: 'startChangeMinStakeTime',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
    inputs: [{internalType: 'uint256', name: '_freq', type: 'uint256'}],
    name: 'startChangeRebalanceFrequency',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
    ...
    name: 'startChangeRewardPercentLP',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
...
async function main() {
  ...
  for (let poolIndex = 0; poolIndex < poolsLength; poolIndex++) {
    let p = await loadBscStabilizePool(
      App,
      tokens,
      prices,
      STBB_CONTRACT,
...
async function loadBscStabilizePool(App, tokens, prices, contract, contractAddress, poolIndex, rewardTokenAddress) {
  const info = await loadBscStabilizePoolInfo(
    App,
    tokens,
    prices,
    contract,

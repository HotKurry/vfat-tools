...
const NUT_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract NutToken', name: '_nut', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
      {internalType: 'address', name: '_feeAddress', type: 'address'},
      {internalType: 'uint256', name: '_nutPerBlock', type: 'uint256'},
  ...
  {inputs: [], name: 'massUpdatePools', outputs: [], stateMutability: 'nonpayable', type: 'function'},
  {
    inputs: [],
    name: 'nut',
    outputs: [{internalType: 'contract NutToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accNutPerShare', type: 'uint256'},
  ...
  {
    inputs: [{internalType: 'uint256', name: '_nutPerBlock', type: 'uint256'}],
...
async function main() {
  ...
  const rewardsPerWeek = (((await NUT_CHEF.nutPerBlock()) / 1e18) * 604800) / 3

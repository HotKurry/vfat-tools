...
const KEBAB_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract KebabToken', name: '_cake', type: 'address'},
      {internalType: 'contract KetchupBar', name: '_syrup', type: 'address'},
  ...
  },
  {
    inputs: [],
    name: 'cake',
    outputs: [{internalType: 'contract KebabToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    inputs: [],
    name: 'syrup',
    outputs: [{internalType: 'contract KetchupBar', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
...
async function main() {
  ...
  const KEBAB_CHEF_ADDR = '0x76FCeffFcf5325c6156cA89639b17464ea833ECd'
  const rewardTokenTicker = 'KEBAB'
  const KEBAB_CHEF = new ethers.Contract(KEBAB_CHEF_ADDR, KEBAB_CHEF_ABI, App.provider)

  const rewardsPerWeek = (((await KEBAB_CHEF.cakePerBlock()) / 1e18) * 604800) / 3

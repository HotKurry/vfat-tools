...
const TACO_CHEF_ABI = [
  {
    inputs: [
      {internalType: 'contract TacoToken', name: '_taco', type: 'address'},
      {internalType: 'address', name: '_devaddr', type: 'address'},
      {internalType: 'address', name: '_feeAddress', type: 'address'},
      {internalType: 'uint256', name: '_tacoPerBlock', type: 'uint256'},
  ...
  },
  {
    ...
    outputs: [
      ...
      {internalType: 'uint256', name: 'accTacoPerShare', type: 'uint256'},
  ...
  },
  {
    inputs: [],
    name: 'taco',
    outputs: [{internalType: 'contract TacoToken', name: '', type: 'address'}],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  {
    inputs: [{internalType: 'uint256', name: '_tacoPerBlock', type: 'uint256'}],
...
async function main() {
  ...
  const rewardsPerWeek = (((await TACO_CHEF.tacoPerBlock()) / 1e18) * 604800) / 3
